...
class R implements ToJsonSerializable {
  final int /*U32*/ a;
  final String b;
  final List<(String, Option<T4>)> c;
  final Option<Option<(List<int /*S64*/>, Option<Option<int /*U64*/>>)>> d;
  ...
  Map<String, Object?> toJson() => {
    ...
    'a': a,
    'b': b,
    'c': c.map((e) => [e.$1, e.$2.toJson((some) => some.toJson())]).toList(),
    'd': d.toJson(
      (some) => some.toJson(
        (some) => [some.$1.toList(), some.$2.toJson((some) => some.toJson())],
      ),
    ),
    'e': e.toJson(),
    'i': i.toJson(),
  ...
  R copyWith({
    int /*U32*/ ? a,
    String? b,
    List<(String, Option<T4>)>? c,
    Option<Option<(List<int /*S64*/>, Option<Option<int /*U64*/>>)>>? d,
...
sealed class HumanApiImports implements ToJsonSerializable {
  ...
  const factory HumanApiImports.adult(
    (String, Option<Option<String>>, (int /*S64*/,)) value,
...
class HumanApiImportsAdult implements HumanApiImports {
  final (String, Option<Option<String>>, (int /*S64*/,)) value;
...
class R1 implements ToJsonSerializable {
  final int _rep;
  final TypesExampleWorld _world;

  R1._(this._rep, this._world) {
    _world._r1Finalizer.attach(this, _rep);
  }

  factory R1.fromJson(Object? json) {
    return R1._(json! as int, TypesExampleWorld.currentZoneWorld()!);
  }
  ...
  /// Comment for f2
  int /*U32*/ length() {
    return _world.api.methodR1Length(self: this);
  }
...
class RoundTripNumbers {
  ...
  RoundTripNumbersListData roundTripNumbersList({
    ...
    final result = results[0];
    return _world.withContext(() => RoundTripNumbersListData.fromJson(result));
  }
}
...
class Api {
  ...
  () class_({Option<Option<T5Api>> break_ = const None()}) {
    _class_([
      break_.toWasm(
        (some) => some.toWasm(
          (some) => some.toWasm(
            null,
            (error) => error.toWasm((some) => some.toWasm()),
          ),
        ),
      ),
    ]);
  ...
  ({Option<()> implements_}) continue_({
    ...
    final r0 = results[0];
    return _world.withContext(
      () => (implements_: Option.fromJson(r0, (some) => ())),
    );
  }
  ...
  final ListValue Function(ListValue) _staticR1StaticDefault;
  String staticR1StaticDefault() {
    final results = _staticR1StaticDefault([]);
    final result = results[0];
    return result is String ? result : (result! as ParsedString).value;
  }
...
class TypesExampleWorld {
  ...
  late final _r1Finalizer = Finalizer<int>(
    (i) => canon_resource_drop(library.componentInstance, R1._spec, i),
  );
  ...
  static Future<TypesExampleWorld> init(
    ...
    library = WasmLibrary(
      ...
      int64Type: Int64TypeConfig.coreInt,
    );
  ...
  static TypesExampleWorld? currentZoneWorld() =>
      Zone.current[_zoneKey] as TypesExampleWorld?;
