...
class WasmRunNativePlatform extends FlutterRustBridgeBase<WasmRunNativeWire>
  ...
  WasmRunNativePlatform(FutureOr<WasmModule> dylib)
...
// Section: api2wire
  ...
  @protected
  Object api2wire_ArcStdSyncMutexComponent(ArcStdSyncMutexComponent raw) {
    return raw.shareOrMove();
  }
  ...
  @protected
  Object api2wire_WAnyRef(WAnyRef raw) {
    return raw.shareOrMove();
  }

  @protected
  Object api2wire_WExnRef(WExnRef raw) {
    return raw.shareOrMove();
  }
  ...
  @protected
  Object api2wire_box_autoadd_WAnyRef(WAnyRef raw) {
    return api2wire_WAnyRef(raw);
  }

  @protected
  Object api2wire_box_autoadd_WExnRef(WExnRef raw) {
    return api2wire_WExnRef(raw);
  }
  ...
  @protected
  List<dynamic> api2wire_box_autoadd_compiled_component(CompiledComponent raw) {
    return api2wire_compiled_component(raw);
  }
  ...
  @protected
  List<dynamic> api2wire_compiled_component(CompiledComponent raw) {
    return [api2wire_ArcStdSyncMutexComponent(raw.field0)];
  }
  ...
  List<dynamic> api2wire_module_config_wasmi(ModuleConfigWasmi raw) {
    return [
      ...
      api2wire_opt_box_autoadd_bool(raw.simd),
      api2wire_opt_box_autoadd_bool(raw.relaxedSimd),
      api2wire_opt_box_autoadd_bool(raw.multiMemory),
      api2wire_opt_box_autoadd_bool(raw.memory64)
    ];
  }
  ...
  List<dynamic> api2wire_module_config_wasmtime(ModuleConfigWasmtime raw) {
    return [
      ...
      api2wire_opt_box_autoadd_bool(raw.wasmTailCall),
      api2wire_opt_box_autoadd_bool(raw.wasmGc),
      api2wire_opt_box_autoadd_bool(raw.wasmFunctionReferences),
      api2wire_opt_box_autoadd_bool(raw.wasmExceptions),
      api2wire_opt_box_autoadd_bool(raw.wasmComponentModel),
  ...
  @protected
  Object? api2wire_opt_box_autoadd_WAnyRef(WAnyRef? raw) {
    return raw == null ? null : api2wire_box_autoadd_WAnyRef(raw);
  }

  @protected
  Object? api2wire_opt_box_autoadd_WExnRef(WExnRef? raw) {
    return raw == null ? null : api2wire_box_autoadd_WExnRef(raw);
  }
  ...
  List<dynamic> api2wire_wasm_val(WasmVal raw) {
    ...
    if (raw is WasmVal_anyRef) {
      return [7, api2wire_opt_box_autoadd_WAnyRef(raw.field0)];
    }
    if (raw is WasmVal_exnRef) {
      return [8, api2wire_opt_box_autoadd_WExnRef(raw.field0)];
    }
...
// Section: finalizer
  ...
  late final Finalizer<PlatformPointer> _ArcStdSyncMutexComponentFinalizer =
      Finalizer<PlatformPointer>(inner.drop_opaque_ArcStdSyncMutexComponent);
  Finalizer<PlatformPointer> get ArcStdSyncMutexComponentFinalizer =>
  ...
  late final Finalizer<PlatformPointer> _WAnyRefFinalizer =
      Finalizer<PlatformPointer>(inner.drop_opaque_WAnyRef);
  Finalizer<PlatformPointer> get WAnyRefFinalizer => _WAnyRefFinalizer;
  late final Finalizer<PlatformPointer> _WExnRefFinalizer =
      Finalizer<PlatformPointer>(inner.drop_opaque_WExnRef);
  Finalizer<PlatformPointer> get WExnRefFinalizer => _WExnRefFinalizer;
...
@JS('wasm_bindgen')
external WasmRunNativeWasmModule get wasmModule;

@JS()
@anonymous
class WasmRunNativeWasmModule implements WasmModule {
  external Object /* Promise */ call([String? moduleName]);
  external WasmRunNativeWasmModule bind(dynamic thisArg, String moduleName);
  ...
  external dynamic /* int? */ wire_detect_wasm_kind(Uint8List wasm_bytes);

  external dynamic /* void */ wire_compile_component(
      NativePortType port_, Uint8List component_wasm, List<dynamic> config);

  external dynamic /* List<dynamic> */ wire_compile_component_sync(
      Uint8List component_wasm, List<dynamic> config);
  ...
  external dynamic /* List<String> */
      wire_get_component_imports__method__CompiledComponent(List<dynamic> that);

  external dynamic /* List<String> */
      wire_get_component_exports__method__CompiledComponent(List<dynamic> that);
  ...
  external dynamic /*  */ drop_opaque_ArcStdSyncMutexComponent(ptr);

  external int /* *const c_void */ share_opaque_ArcStdSyncMutexComponent(ptr);
  ...
  external dynamic /*  */ drop_opaque_WAnyRef(ptr);

  external int /* *const c_void */ share_opaque_WAnyRef(ptr);

  external dynamic /*  */ drop_opaque_WExnRef(ptr);

  external int /* *const c_void */ share_opaque_WExnRef(ptr);
...
class WasmRunNativeWire
    extends FlutterRustBridgeWasmWireBase<WasmRunNativeWasmModule> {
  WasmRunNativeWire(FutureOr<WasmModule> module)
      : super(WasmModule.cast<WasmRunNativeWasmModule>(module));
  ...
  dynamic /* int? */ wire_detect_wasm_kind(Uint8List wasm_bytes) =>
      wasmModule.wire_detect_wasm_kind(wasm_bytes);

  void wire_compile_component(NativePortType port_, Uint8List component_wasm,
          List<dynamic> config) =>
      wasmModule.wire_compile_component(port_, component_wasm, config);

  dynamic /* List<dynamic> */ wire_compile_component_sync(
          Uint8List component_wasm, List<dynamic> config) =>
      wasmModule.wire_compile_component_sync(component_wasm, config);
  ...
  dynamic /* List<String> */
      wire_get_component_imports__method__CompiledComponent(
              List<dynamic> that) =>
          wasmModule
              .wire_get_component_imports__method__CompiledComponent(that);

  dynamic /* List<String> */
      wire_get_component_exports__method__CompiledComponent(
              List<dynamic> that) =>
          wasmModule
              .wire_get_component_exports__method__CompiledComponent(that);
  ...
  dynamic /*  */ drop_opaque_ArcStdSyncMutexComponent(ptr) =>
      wasmModule.drop_opaque_ArcStdSyncMutexComponent(ptr);

  int /* *const c_void */ share_opaque_ArcStdSyncMutexComponent(ptr) =>
      wasmModule.share_opaque_ArcStdSyncMutexComponent(ptr);
  ...
  dynamic /*  */ drop_opaque_WAnyRef(ptr) =>
      wasmModule.drop_opaque_WAnyRef(ptr);

  int /* *const c_void */ share_opaque_WAnyRef(ptr) =>
      wasmModule.share_opaque_WAnyRef(ptr);

  dynamic /*  */ drop_opaque_WExnRef(ptr) =>
      wasmModule.drop_opaque_WExnRef(ptr);

  int /* *const c_void */ share_opaque_WExnRef(ptr) =>
      wasmModule.share_opaque_WExnRef(ptr);
