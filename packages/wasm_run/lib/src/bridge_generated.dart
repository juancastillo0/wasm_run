...
// Explicit dart:core import to ensure core types are not shadowed by ffi types
import 'dart:core';
import 'dart:convert';
import 'dart:async';
...
abstract class WasmRunNative {
  ...
  WasmBinaryKind? detectWasmKind({required Uint8List wasmBytes, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kDetectWasmKindConstMeta;

  /// Compile a WebAssembly Component (for WASI Preview2)
  Future<CompiledComponent> compileComponent(
      {required Uint8List componentWasm,
      required ModuleConfig config,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kCompileComponentConstMeta;

  /// Compile a WebAssembly Component synchronously
  CompiledComponent compileComponentSync(
      {required Uint8List componentWasm,
      required ModuleConfig config,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kCompileComponentSyncConstMeta;
  ...
  List<String> getComponentImportsMethodCompiledComponent(
      {required CompiledComponent that, dynamic hint});

  FlutterRustBridgeTaskConstMeta
      get kGetComponentImportsMethodCompiledComponentConstMeta;

  /// Get the component's exports
  List<String> getComponentExportsMethodCompiledComponent(
      {required CompiledComponent that, dynamic hint});

  FlutterRustBridgeTaskConstMeta
      get kGetComponentExportsMethodCompiledComponentConstMeta;
  ...
  DropFnType get dropOpaqueArcStdSyncMutexComponent;
  ShareFnType get shareOpaqueArcStdSyncMutexComponent;
  ...
  DropFnType get dropOpaqueWAnyRef;
  ShareFnType get shareOpaqueWAnyRef;
  OpaqueTypeFinalizer get WAnyRefFinalizer;

  DropFnType get dropOpaqueWExnRef;
  ShareFnType get shareOpaqueWExnRef;
  OpaqueTypeFinalizer get WExnRefFinalizer;
...
@sealed
class ArcStdSyncMutexComponent extends FrbOpaque {
  final WasmRunNative bridge;
  ArcStdSyncMutexComponent.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
  DropFnType get dropFn => bridge.dropOpaqueArcStdSyncMutexComponent;

  @override
  ShareFnType get shareFn => bridge.shareOpaqueArcStdSyncMutexComponent;

  @override
  OpaqueTypeFinalizer get staticFinalizer =>
      bridge.ArcStdSyncMutexComponentFinalizer;
}
...
@sealed
class WAnyRef extends FrbOpaque {
  final WasmRunNative bridge;
  WAnyRef.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
  @override
  DropFnType get dropFn => bridge.dropOpaqueWAnyRef;

  @override
  ShareFnType get shareFn => bridge.shareOpaqueWAnyRef;

  @override
  OpaqueTypeFinalizer get staticFinalizer => bridge.WAnyRefFinalizer;
}

@sealed
class WExnRef extends FrbOpaque {
  final WasmRunNative bridge;
  WExnRef.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
  @override
  DropFnType get dropFn => bridge.dropOpaqueWExnRef;

  @override
  ShareFnType get shareFn => bridge.shareOpaqueWExnRef;

  @override
  OpaqueTypeFinalizer get staticFinalizer => bridge.WExnRefFinalizer;
}
...
class CompiledComponent {
  final WasmRunNative bridge;
  final ArcStdSyncMutexComponent field0;
  ...
  /// Get the component's imports
  List<String> getComponentImports({dynamic hint}) =>
      bridge.getComponentImportsMethodCompiledComponent(
        that: this,
      );

  /// Get the component's exports
  List<String> getComponentExports({dynamic hint}) =>
      bridge.getComponentExportsMethodCompiledComponent(
        that: this,
      );
}
...
class ModuleConfigWasmtime {
  ...
  const ModuleConfigWasmtime({
    ...
    this.wasmTailCall,
    this.wasmGc,
    this.wasmFunctionReferences,
    this.wasmExceptions,
    this.wasmComponentModel,
...
class WasmVal with _$WasmVal {
  ...
  const factory WasmVal.anyRef([
    WAnyRef? field0,
  ]) = WasmVal_anyRef;

  /// A nullable exception reference (wasmtime exception handling only).
  const factory WasmVal.exnRef([
    WExnRef? field0,
  ]) = WasmVal_exnRef;
}
...
class WasmRunNativeImpl implements WasmRunNative {
  final WasmRunNativePlatform _platform;

  /// Exposes the platform for internal use (e.g., wire conversion).
  WasmRunNativePlatform get platform => _platform;

  factory WasmRunNativeImpl(ExternalLibrary dylib) =>
      WasmRunNativeImpl.raw(WasmRunNativePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory WasmRunNativeImpl.wasm(FutureOr<WasmModule> module) =>
      WasmRunNativeImpl(module as ExternalLibrary);
  WasmRunNativeImpl.raw(this._platform);
  WasmRunModuleId moduleBuilder(
      {required CompiledModule module,
      int? numThreads,
      WasiConfigNative? wasiConfig,
  ...
  WasmBinaryKind? detectWasmKind({required Uint8List wasmBytes, dynamic hint}) {
    var arg0 = _platform.api2wire_uint_8_list(wasmBytes);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_detect_wasm_kind(arg0),
      parseSuccessData: _wire2api_opt_box_autoadd_wasm_binary_kind,
      parseErrorData: null,
      constMeta: kDetectWasmKindConstMeta,
      argValues: [wasmBytes],
      hint: hint,
    ));
  }
  ...
  Future<CompiledComponent> compileComponent(
      ...
      required ModuleConfig config,
      dynamic hint}) {
    var arg0 = _platform.api2wire_uint_8_list(componentWasm);
    var arg1 = _platform.api2wire_box_autoadd_module_config(config);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_compile_component(port_, arg0, arg1),
      parseSuccessData: (d) => _wire2api_compiled_component(d),
      parseErrorData: _wire2api_FrbAnyhowException,
      constMeta: kCompileComponentConstMeta,
  ...
  CompiledComponent compileComponentSync(
    ...
    var arg1 = _platform.api2wire_box_autoadd_module_config(config);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_compile_component_sync(arg0, arg1),
      parseSuccessData: _wire2api_compiled_component,
      parseErrorData: _wire2api_FrbAnyhowException,
      constMeta: kCompileComponentSyncConstMeta,
      argValues: [componentWasm, config],
      hint: hint,
    ));
  }
  ...
  Global createGlobalMethodWasmRunModuleId(
    ...
    var arg2 = _platform.api2wire_box_autoadd_bool(mutable);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner
  ...
  List<String> getComponentImportsMethodCompiledComponent(
      {required CompiledComponent that, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_compiled_component(that);
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner
          .wire_get_component_imports__method__CompiledComponent(arg0),
      parseSuccessData: _wire2api_StringList,
      parseErrorData: null,
      constMeta: kGetComponentImportsMethodCompiledComponentConstMeta,
      argValues: [that],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kGetComponentImportsMethodCompiledComponentConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "get_component_imports__method__CompiledComponent",
            argNames: ["that"],
          );
  ...
  List<String> getComponentExportsMethodCompiledComponent(
    ...
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner
          .wire_get_component_exports__method__CompiledComponent(arg0),
      parseSuccessData: _wire2api_StringList,
      parseErrorData: null,
      constMeta: kGetComponentExportsMethodCompiledComponentConstMeta,
      argValues: [that],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kGetComponentExportsMethodCompiledComponentConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "get_component_exports__method__CompiledComponent",
            argNames: ["that"],
          );
  ...
  DropFnType get dropOpaqueArcStdSyncMutexComponent =>
      _platform.inner.drop_opaque_ArcStdSyncMutexComponent;
  ShareFnType get shareOpaqueArcStdSyncMutexComponent =>
      _platform.inner.share_opaque_ArcStdSyncMutexComponent;
  OpaqueTypeFinalizer get ArcStdSyncMutexComponentFinalizer =>
      _platform.ArcStdSyncMutexComponentFinalizer;
  ...
  DropFnType get dropOpaqueWAnyRef => _platform.inner.drop_opaque_WAnyRef;
  ShareFnType get shareOpaqueWAnyRef => _platform.inner.share_opaque_WAnyRef;
  OpaqueTypeFinalizer get WAnyRefFinalizer => _platform.WAnyRefFinalizer;

  DropFnType get dropOpaqueWExnRef => _platform.inner.drop_opaque_WExnRef;
  ShareFnType get shareOpaqueWExnRef => _platform.inner.share_opaque_WExnRef;
  OpaqueTypeFinalizer get WExnRefFinalizer => _platform.WExnRefFinalizer;
...
// Section: wire2api
  ...
  ArcRwLockSharedMemory _wire2api_ArcRwLockSharedMemory(dynamic raw) {
    return ArcRwLockSharedMemory.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  ArcStdSyncMutexComponent _wire2api_ArcStdSyncMutexComponent(dynamic raw) {
    return ArcStdSyncMutexComponent.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  ArcStdSyncMutexModule _wire2api_ArcStdSyncMutexModule(dynamic raw) {
    return ArcStdSyncMutexModule.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  CallStack _wire2api_CallStack(dynamic raw) {
    return CallStack.fromRaw(raw[0] as int, raw[1] as int, this);
  }
  ...
  Global _wire2api_Global(dynamic raw) {
    return Global.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  Memory _wire2api_Memory(dynamic raw) {
    return Memory.fromRaw(raw[0] as int, raw[1] as int, this);
  }
  ...
  Table _wire2api_Table(dynamic raw) {
    return Table.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  WAnyRef _wire2api_WAnyRef(dynamic raw) {
    return WAnyRef.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  WExnRef _wire2api_WExnRef(dynamic raw) {
    return WExnRef.fromRaw(raw[0] as int, raw[1] as int, this);
  }

  WFunc _wire2api_WFunc(dynamic raw) {
    return WFunc.fromRaw(raw[0] as int, raw[1] as int, this);
  }
  ...
  WAnyRef _wire2api_box_autoadd_WAnyRef(dynamic raw) {
    return _wire2api_WAnyRef(raw);
  }

  WExnRef _wire2api_box_autoadd_WExnRef(dynamic raw) {
    return _wire2api_WExnRef(raw);
  }
  ...
  WasmBinaryKind _wire2api_box_autoadd_wasm_binary_kind(dynamic raw) {
    return _wire2api_wasm_binary_kind(raw);
  }
  ...
  CompiledComponent _wire2api_compiled_component(dynamic raw) {
    final arr = raw as List<dynamic>;
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return CompiledComponent(
      bridge: this,
      field0: _wire2api_ArcStdSyncMutexComponent(arr[0]),
    );
  }
  ...
  WAnyRef? _wire2api_opt_box_autoadd_WAnyRef(dynamic raw) {
    return raw == null ? null : _wire2api_box_autoadd_WAnyRef(raw);
  }

  WExnRef? _wire2api_opt_box_autoadd_WExnRef(dynamic raw) {
    return raw == null ? null : _wire2api_box_autoadd_WExnRef(raw);
  }
  ...
  WasmBinaryKind? _wire2api_opt_box_autoadd_wasm_binary_kind(dynamic raw) {
    return raw == null ? null : _wire2api_box_autoadd_wasm_binary_kind(raw);
  }
  ...
  WasmBinaryKind _wire2api_wasm_binary_kind(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 7:
        return WasmVal_anyRef(
          _wire2api_opt_box_autoadd_WAnyRef(raw[1]),
        );
      case 8:
        return WasmVal_exnRef(
          _wire2api_opt_box_autoadd_WExnRef(raw[1]),
        );
      default:
        throw Exception("unreachable");
    }
