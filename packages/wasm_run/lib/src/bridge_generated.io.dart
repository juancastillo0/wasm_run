...
// Section: api2wire
  ...
  @protected
  wire_ArcStdSyncMutexComponent api2wire_ArcStdSyncMutexComponent(
      ArcStdSyncMutexComponent raw) {
    final ptr = inner.new_ArcStdSyncMutexComponent();
    _api_fill_to_wire_ArcStdSyncMutexComponent(raw, ptr);
    return ptr;
  }
  ...
  @protected
  wire_WAnyRef api2wire_WAnyRef(WAnyRef raw) {
    final ptr = inner.new_WAnyRef();
    _api_fill_to_wire_WAnyRef(raw, ptr);
    return ptr;
  }

  @protected
  wire_WExnRef api2wire_WExnRef(WExnRef raw) {
    final ptr = inner.new_WExnRef();
    _api_fill_to_wire_WExnRef(raw, ptr);
    return ptr;
  }
  ...
  @protected
  ffi.Pointer<wire_WAnyRef> api2wire_box_autoadd_WAnyRef(WAnyRef raw) {
    final ptr = inner.new_box_autoadd_WAnyRef_0();
    _api_fill_to_wire_WAnyRef(raw, ptr.ref);
    return ptr;
  }

  @protected
  ffi.Pointer<wire_WExnRef> api2wire_box_autoadd_WExnRef(WExnRef raw) {
    final ptr = inner.new_box_autoadd_WExnRef_0();
    _api_fill_to_wire_WExnRef(raw, ptr.ref);
    return ptr;
  }
  ...
  @protected
  ffi.Pointer<wire_CompiledComponent> api2wire_box_autoadd_compiled_component(
      CompiledComponent raw) {
    final ptr = inner.new_box_autoadd_compiled_component_0();
    _api_fill_to_wire_compiled_component(raw, ptr.ref);
    return ptr;
  }
  ...
  @protected
  ffi.Pointer<wire_WAnyRef> api2wire_opt_box_autoadd_WAnyRef(WAnyRef? raw) {
    return raw == null ? ffi.nullptr : api2wire_box_autoadd_WAnyRef(raw);
  }

  @protected
  ffi.Pointer<wire_WExnRef> api2wire_opt_box_autoadd_WExnRef(WExnRef? raw) {
    return raw == null ? ffi.nullptr : api2wire_box_autoadd_WExnRef(raw);
  }
...
// Section: finalizer
  ...
  late final OpaqueTypeFinalizer _ArcStdSyncMutexComponentFinalizer =
      OpaqueTypeFinalizer(inner._drop_opaque_ArcStdSyncMutexComponentPtr);
  OpaqueTypeFinalizer get ArcStdSyncMutexComponentFinalizer =>
  ...
  late final OpaqueTypeFinalizer _WAnyRefFinalizer =
      OpaqueTypeFinalizer(inner._drop_opaque_WAnyRefPtr);
  OpaqueTypeFinalizer get WAnyRefFinalizer => _WAnyRefFinalizer;
  late final OpaqueTypeFinalizer _WExnRefFinalizer =
      OpaqueTypeFinalizer(inner._drop_opaque_WExnRefPtr);
  OpaqueTypeFinalizer get WExnRefFinalizer => _WExnRefFinalizer;
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_ArcStdSyncMutexComponent(
      ArcStdSyncMutexComponent apiObj, wire_ArcStdSyncMutexComponent wireObj) {
    wireObj.ptr = apiObj.shareOrMove();
  }
  ...
  void _api_fill_to_wire_WAnyRef(WAnyRef apiObj, wire_WAnyRef wireObj) {
    wireObj.ptr = apiObj.shareOrMove();
  }

  void _api_fill_to_wire_WExnRef(WExnRef apiObj, wire_WExnRef wireObj) {
    wireObj.ptr = apiObj.shareOrMove();
  }
  ...
  void _api_fill_to_wire_box_autoadd_WAnyRef(
      WAnyRef apiObj, ffi.Pointer<wire_WAnyRef> wireObj) {
    _api_fill_to_wire_WAnyRef(apiObj, wireObj.ref);
  }

  void _api_fill_to_wire_box_autoadd_WExnRef(
      WExnRef apiObj, ffi.Pointer<wire_WExnRef> wireObj) {
    _api_fill_to_wire_WExnRef(apiObj, wireObj.ref);
  }
  ...
  void _api_fill_to_wire_box_autoadd_compiled_component(
      CompiledComponent apiObj, ffi.Pointer<wire_CompiledComponent> wireObj) {
    _api_fill_to_wire_compiled_component(apiObj, wireObj.ref);
  }
  ...
  void _api_fill_to_wire_compiled_component(
      CompiledComponent apiObj, wire_CompiledComponent wireObj) {
    wireObj.field0 = api2wire_ArcStdSyncMutexComponent(apiObj.field0);
  }
  ...
  void _api_fill_to_wire_module_config_wasmi(
    ...
    wireObj.simd = api2wire_opt_box_autoadd_bool(apiObj.simd);
    wireObj.relaxed_simd = api2wire_opt_box_autoadd_bool(apiObj.relaxedSimd);
    wireObj.multi_memory = api2wire_opt_box_autoadd_bool(apiObj.multiMemory);
    wireObj.memory64 = api2wire_opt_box_autoadd_bool(apiObj.memory64);
  }
  ...
  void _api_fill_to_wire_module_config_wasmtime(
    ...
    wireObj.wasm_tail_call = api2wire_opt_box_autoadd_bool(apiObj.wasmTailCall);
    wireObj.wasm_gc = api2wire_opt_box_autoadd_bool(apiObj.wasmGc);
    wireObj.wasm_function_references =
        api2wire_opt_box_autoadd_bool(apiObj.wasmFunctionReferences);
    wireObj.wasm_exceptions =
        api2wire_opt_box_autoadd_bool(apiObj.wasmExceptions);
    wireObj.wasm_component_model =
        api2wire_opt_box_autoadd_bool(apiObj.wasmComponentModel);
  ...
  void _api_fill_to_wire_wasm_val(WasmVal apiObj, wire_WasmVal wireObj) {
    ...
    if (apiObj is WasmVal_anyRef) {
      var pre_field0 = api2wire_opt_box_autoadd_WAnyRef(apiObj.field0);
      wireObj.tag = 7;
      wireObj.kind = inner.inflate_WasmVal_anyRef();
      wireObj.kind.ref.anyRef.ref.field0 = pre_field0;
      return;
    }
    if (apiObj is WasmVal_exnRef) {
      var pre_field0 = api2wire_opt_box_autoadd_WExnRef(apiObj.field0);
      wireObj.tag = 8;
      wireObj.kind = inner.inflate_WasmVal_exnRef();
      wireObj.kind.ref.exnRef.ref.field0 = pre_field0;
      return;
    }
  }
}
...
class WasmRunNativeWire implements FlutterRustBridgeWireBase {
  ...
  WasmRunNativeWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  WasmRunNativeWire.fromLookup(
  ...
  WireSyncReturn wire_detect_wasm_kind(
    ffi.Pointer<wire_uint_8_list> wasm_bytes,
  ) {
    return _wire_detect_wasm_kind(wasm_bytes);
  }

  late final _wire_detect_wasm_kindPtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturn Function(
              ffi.Pointer<wire_uint_8_list>)>>('wire_detect_wasm_kind');
  late final _wire_detect_wasm_kind = _wire_detect_wasm_kindPtr
      .asFunction<WireSyncReturn Function(ffi.Pointer<wire_uint_8_list>)>();

  void wire_compile_component(
    int port_,
    ffi.Pointer<wire_uint_8_list> component_wasm,
    ffi.Pointer<wire_ModuleConfig> config,
  ) {
    return _wire_compile_component(port_, component_wasm, config);
  }

  late final _wire_compile_componentPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
            ffi.Int64,
            ffi.Pointer<wire_uint_8_list>,
            ffi.Pointer<wire_ModuleConfig>,
          )>>('wire_compile_component');
  late final _wire_compile_component = _wire_compile_componentPtr.asFunction<
      void Function(
        int,
        ffi.Pointer<wire_uint_8_list>,
        ffi.Pointer<wire_ModuleConfig>,
  ...
  WireSyncReturn wire_compile_component_sync(
    ffi.Pointer<wire_uint_8_list> component_wasm,
    ffi.Pointer<wire_ModuleConfig> config,
  ) {
    return _wire_compile_component_sync(component_wasm, config);
  }

  late final _wire_compile_component_syncPtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturn Function(
            ffi.Pointer<wire_uint_8_list>,
            ffi.Pointer<wire_ModuleConfig>,
          )>>('wire_compile_component_sync');
  late final _wire_compile_component_sync =
      _wire_compile_component_syncPtr.asFunction<
          WireSyncReturn Function(
            ffi.Pointer<wire_uint_8_list>,
            ffi.Pointer<wire_ModuleConfig>,
          )>();
  ...
  void wire_stdio_stream__method__WasmRunModuleId(
    ...
    return _wire_stdio_stream__method__WasmRunModuleId(port_, that, kind);
  }
  ...
  WireSyncReturn wire_get_component_imports__method__CompiledComponent(
    ffi.Pointer<wire_CompiledComponent> that,
  ) {
    return _wire_get_component_imports__method__CompiledComponent(that);
  }

  late final _wire_get_component_imports__method__CompiledComponentPtr =
      _lookup<
              ffi.NativeFunction<
                  WireSyncReturn Function(
                      ffi.Pointer<wire_CompiledComponent>)>>(
          'wire_get_component_imports__method__CompiledComponent');
  late final _wire_get_component_imports__method__CompiledComponent =
      _wire_get_component_imports__method__CompiledComponentPtr.asFunction<
          WireSyncReturn Function(ffi.Pointer<wire_CompiledComponent>)>();

  WireSyncReturn wire_get_component_exports__method__CompiledComponent(
    ffi.Pointer<wire_CompiledComponent> that,
  ) {
    return _wire_get_component_exports__method__CompiledComponent(that);
  }

  late final _wire_get_component_exports__method__CompiledComponentPtr =
      _lookup<
              ffi.NativeFunction<
                  WireSyncReturn Function(
                      ffi.Pointer<wire_CompiledComponent>)>>(
          'wire_get_component_exports__method__CompiledComponent');
  late final _wire_get_component_exports__method__CompiledComponent =
      _wire_get_component_exports__method__CompiledComponentPtr.asFunction<
          WireSyncReturn Function(ffi.Pointer<wire_CompiledComponent>)>();
  ...
  wire_ArcStdSyncMutexComponent new_ArcStdSyncMutexComponent() {
    return _new_ArcStdSyncMutexComponent();
  }

  late final _new_ArcStdSyncMutexComponentPtr =
      _lookup<ffi.NativeFunction<wire_ArcStdSyncMutexComponent Function()>>(
    'new_ArcStdSyncMutexComponent',
  );
  late final _new_ArcStdSyncMutexComponent = _new_ArcStdSyncMutexComponentPtr
      .asFunction<wire_ArcStdSyncMutexComponent Function()>();
  ...
  wire_WAnyRef new_WAnyRef() {
    return _new_WAnyRef();
  }

  late final _new_WAnyRefPtr =
      _lookup<ffi.NativeFunction<wire_WAnyRef Function()>>('new_WAnyRef');
  late final _new_WAnyRef =
      _new_WAnyRefPtr.asFunction<wire_WAnyRef Function()>();

  wire_WExnRef new_WExnRef() {
    return _new_WExnRef();
  }

  late final _new_WExnRefPtr =
      _lookup<ffi.NativeFunction<wire_WExnRef Function()>>('new_WExnRef');
  late final _new_WExnRef =
      _new_WExnRefPtr.asFunction<wire_WExnRef Function()>();
  ...
  ffi.Pointer<wire_WAnyRef> new_box_autoadd_WAnyRef_0() {
    return _new_box_autoadd_WAnyRef_0();
  }

  late final _new_box_autoadd_WAnyRef_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_WAnyRef> Function()>>(
    'new_box_autoadd_WAnyRef_0',
  );
  late final _new_box_autoadd_WAnyRef_0 = _new_box_autoadd_WAnyRef_0Ptr
      .asFunction<ffi.Pointer<wire_WAnyRef> Function()>();

  ffi.Pointer<wire_WExnRef> new_box_autoadd_WExnRef_0() {
    return _new_box_autoadd_WExnRef_0();
  }

  late final _new_box_autoadd_WExnRef_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_WExnRef> Function()>>(
    'new_box_autoadd_WExnRef_0',
  );
  late final _new_box_autoadd_WExnRef_0 = _new_box_autoadd_WExnRef_0Ptr
      .asFunction<ffi.Pointer<wire_WExnRef> Function()>();
  ...
  late final _new_box_autoadd_compiled_component_0Ptr = _lookup<
          ffi.NativeFunction<ffi.Pointer<wire_CompiledComponent> Function()>>(
      'new_box_autoadd_compiled_component_0');
  late final _new_box_autoadd_compiled_component_0 =
      _new_box_autoadd_compiled_component_0Ptr
          .asFunction<ffi.Pointer<wire_CompiledComponent> Function()>();
  ...
  void drop_opaque_ArcStdSyncMutexComponent(ffi.Pointer<ffi.Void> ptr) {
    return _drop_opaque_ArcStdSyncMutexComponent(ptr);
  }

  late final _drop_opaque_ArcStdSyncMutexComponentPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'drop_opaque_ArcStdSyncMutexComponent',
  );
  late final _drop_opaque_ArcStdSyncMutexComponent =
      _drop_opaque_ArcStdSyncMutexComponentPtr
          .asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Void> share_opaque_ArcStdSyncMutexComponent(
    ffi.Pointer<ffi.Void> ptr,
  ) {
    return _share_opaque_ArcStdSyncMutexComponent(ptr);
  }

  late final _share_opaque_ArcStdSyncMutexComponentPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Void>)>>('share_opaque_ArcStdSyncMutexComponent');
  late final _share_opaque_ArcStdSyncMutexComponent =
      _share_opaque_ArcStdSyncMutexComponentPtr
          .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();
  ...
  void drop_opaque_WAnyRef(ffi.Pointer<ffi.Void> ptr) {
    return _drop_opaque_WAnyRef(ptr);
  }

  late final _drop_opaque_WAnyRefPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'drop_opaque_WAnyRef',
  );
  late final _drop_opaque_WAnyRef = _drop_opaque_WAnyRefPtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Void> share_opaque_WAnyRef(ffi.Pointer<ffi.Void> ptr) {
    return _share_opaque_WAnyRef(ptr);
  }

  late final _share_opaque_WAnyRefPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Void>)>>('share_opaque_WAnyRef');
  late final _share_opaque_WAnyRef = _share_opaque_WAnyRefPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();

  void drop_opaque_WExnRef(ffi.Pointer<ffi.Void> ptr) {
    return _drop_opaque_WExnRef(ptr);
  }

  late final _drop_opaque_WExnRefPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'drop_opaque_WExnRef',
  );
  late final _drop_opaque_WExnRef = _drop_opaque_WExnRefPtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Void> share_opaque_WExnRef(ffi.Pointer<ffi.Void> ptr) {
    return _share_opaque_WExnRef(ptr);
  }

  late final _share_opaque_WExnRefPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Void>)>>('share_opaque_WExnRef');
  late final _share_opaque_WExnRef = _share_opaque_WExnRefPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();
  ...
  ffi.Pointer<WasmValKind> inflate_WasmVal_anyRef() {
    return _inflate_WasmVal_anyRef();
  }

  late final _inflate_WasmVal_anyRefPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<WasmValKind> Function()>>(
    'inflate_WasmVal_anyRef',
  );
  late final _inflate_WasmVal_anyRef = _inflate_WasmVal_anyRefPtr
      .asFunction<ffi.Pointer<WasmValKind> Function()>();

  ffi.Pointer<WasmValKind> inflate_WasmVal_exnRef() {
    return _inflate_WasmVal_exnRef();
  }

  late final _inflate_WasmVal_exnRefPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<WasmValKind> Function()>>(
    'inflate_WasmVal_exnRef',
  );
  late final _inflate_WasmVal_exnRef = _inflate_WasmVal_exnRefPtr
      .asFunction<ffi.Pointer<WasmValKind> Function()>();
...
final class wire_WAnyRef extends ffi.Struct {
  external ffi.Pointer<ffi.Void> ptr;
}

final class wire_WasmVal_anyRef extends ffi.Struct {
  external ffi.Pointer<wire_WAnyRef> field0;
}

final class wire_WExnRef extends ffi.Struct {
  external ffi.Pointer<ffi.Void> ptr;
}

final class wire_WasmVal_exnRef extends ffi.Struct {
  external ffi.Pointer<wire_WExnRef> field0;
}
...
final class WasmValKind extends ffi.Union {
  ...
  external ffi.Pointer<wire_WasmVal_anyRef> anyRef;

  external ffi.Pointer<wire_WasmVal_exnRef> exnRef;
}
...
final class wire_ArcStdSyncMutexComponent extends ffi.Struct {
  external ffi.Pointer<ffi.Void> ptr;
}

final class wire_CompiledComponent extends ffi.Struct {
  external wire_ArcStdSyncMutexComponent field0;
}
