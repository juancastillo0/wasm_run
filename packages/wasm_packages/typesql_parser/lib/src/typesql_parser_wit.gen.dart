...
class SqlAstRef implements ToJsonSerializable {
  ...
  const SqlAstRef({required this.index_});
  ...
  factory SqlAstRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SqlAstRef(index_: index_! as int),
  ...
  SqlAstRef copyWith({int /*U32*/ ? index_}) =>
  ...
  factory SqlExplain.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        format: Option.fromJson(
          format,
          (some) => AnalyzeFormat.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class Commit implements SqlAst, ToJsonSerializable {
  final bool chain;
  const Commit({required this.chain});
  ...
  factory Commit.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final chain] || (final chain,) => Commit(chain: chain! as bool),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  Map<String, Object?> toJson() => {'runtimeType': 'Commit', 'chain': chain};
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Commit copyWith({bool? chain}) => Commit(chain: chain ?? this.chain);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Commit &&
...
class Rollback implements SqlAst, ToJsonSerializable {
  final bool chain;
  const Rollback({required this.chain});
  ...
  factory Rollback.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final chain] || (final chain,) => Rollback(chain: chain! as bool),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  Map<String, Object?> toJson() => {'runtimeType': 'Rollback', 'chain': chain};
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Rollback copyWith({bool? chain}) => Rollback(chain: chain ?? this.chain);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Rollback &&
...
enum TransactionAccessMode implements ToJsonSerializable {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'TransactionAccessMode',
    _spec.labels[index]: null,
  };
...
enum TransactionIsolationLevel implements ToJsonSerializable {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'TransactionIsolationLevel',
    _spec.labels[index]: null,
  };
...
sealed class TransactionMode implements ToJsonSerializable {
  ...
  factory TransactionMode.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) || [0, final value] => TransactionModeAccessMode(
...
class StartTransaction implements SqlAst, ToJsonSerializable {
  ...
  const StartTransaction({required this.modes});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  StartTransaction copyWith({List<TransactionMode>? modes}) =>
...
class CreateFunctionUsingJar implements CreateFunctionUsing {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'CreateFunctionUsingJar',
    'jar': value,
  };
...
class CreateFunctionUsingFile implements CreateFunctionUsing {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'CreateFunctionUsingFile',
    'file': value,
  };
...
class CreateFunctionUsingArchive implements CreateFunctionUsing {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'CreateFunctionUsingArchive',
    'archive': value,
  };
...
class UniqueOption implements ToJsonSerializable {
  ...
  const UniqueOption({required this.isPrimary});
  ...
  factory UniqueOption.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final isPrimary] ||
      (final isPrimary,) => UniqueOption(isPrimary: isPrimary! as bool),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  UniqueOption copyWith({bool? isPrimary}) =>
...
class DropPrimaryKey implements AlterTableOperation, ToJsonSerializable {
  ...
  @override
  Map<String, Object?> toJson() => {'runtimeType': 'DropPrimaryKey'};
...
class DataTypeRef implements ToJsonSerializable {
  final int /*U32*/ index_;
  const DataTypeRef({required this.index_});
  ...
  factory DataTypeRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => DataTypeRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DataTypeRef copyWith({int /*U32*/ ? index_}) =>
...
class CharacterLength implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.CharacterLength.html
  const CharacterLength({required this.length, this.unit});
  ...
  factory CharacterLength.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final length, final unit) => CharacterLength(
        length: bigIntFromJson(length),
        unit: Option.fromJson(
          unit,
          (some) => CharLengthUnits.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class ExactNumberInfo implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/enum.ExactNumberInfo.html
  const ExactNumberInfo({this.precision, this.scale});
  ...
  factory ExactNumberInfo.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final precision, final scale) => ExactNumberInfo(
        precision: Option.fromJson(
          precision,
  ...
  List<Object?> toWasm() => [
    ...
    (scale == null ? const None().toWasm() : Option.fromValue(scale).toWasm()),
  ];
  @override
  String toString() =>
...
class TimestampType implements ToJsonSerializable {
  ...
  const TimestampType({this.value, required this.timezoneInfo});
  ...
  factory TimestampType.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final value, final timezoneInfo) => TimestampType(
  ...
  /// Returns this as a WASM canonical abi value.
  List<Object?> toWasm() => [
    (value == null ? const None().toWasm() : Option.fromValue(value).toWasm()),
    timezoneInfo.toWasm(),
  ];
  @override
  String toString() =>
...
class Ident implements Expr, ToJsonSerializable {
  ...
  const Ident({required this.value, this.quoteStyle});
  ...
  factory Ident.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final value, final quoteStyle) => Ident(
        value: value is String ? value : (value! as ParsedString).value,
        quoteStyle: Option.fromJson(
          quoteStyle,
          (some) => some! as String,
        ).value,
      ),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Ident copyWith({String? value, Option<String /*Char*/>? quoteStyle}) => Ident(
...
class ShowVariable implements SqlAst, ToJsonSerializable {
  ...
  const ShowVariable({required this.variable});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ShowVariable copyWith({List<Ident>? variable}) =>
...
class SqlUse implements SqlAst, ToJsonSerializable {
  final Ident dbName;
  const SqlUse({required this.dbName});
  ...
  factory SqlUse.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final dbName] ||
      (final dbName,) => SqlUse(dbName: Ident.fromJson(dbName)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlUse copyWith({Ident? dbName}) => SqlUse(dbName: dbName ?? this.dbName);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SqlUse &&
...
class Savepoint implements SqlAst, ToJsonSerializable {
  final Ident name;
  const Savepoint({required this.name});
  ...
  factory Savepoint.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final name] || (final name,) => Savepoint(name: Ident.fromJson(name)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Savepoint copyWith({Ident? name}) => Savepoint(name: name ?? this.name);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Savepoint &&
...
class DropConstraint implements AlterTableOperation, ToJsonSerializable {
  ...
  factory DropConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final ifExists, final name, final cascade) => DropConstraint(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DropConstraint copyWith({bool? ifExists, Ident? name, bool? cascade}) =>
      DropConstraint(
...
class DropColumn implements AlterTableOperation, ToJsonSerializable {
  ...
  factory DropColumn.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final columnName, final ifExists, final cascade) => DropColumn(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DropColumn copyWith({Ident? columnName, bool? ifExists, bool? cascade}) =>
      DropColumn(
...
class RenameColumn implements AlterTableOperation, ToJsonSerializable {
  ...
  factory RenameColumn.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final oldColumnName, final newColumnName) => RenameColumn(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  RenameColumn copyWith({Ident? oldColumnName, Ident? newColumnName}) =>
      RenameColumn(
...
class RenameConstraint implements AlterTableOperation, ToJsonSerializable {
  final Ident oldName;
  final Ident newName;
  const RenameConstraint({required this.oldName, required this.newName});
  ...
  factory RenameConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final oldName, final newName) => RenameConstraint(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  RenameConstraint copyWith({Ident? oldName, Ident? newName}) =>
      RenameConstraint(
...
class ShowCreate implements SqlAst, ToJsonSerializable {
  ...
  const ShowCreate({required this.objType, required this.objName});
  ...
  factory ShowCreate.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final objType, final objName) => ShowCreate(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ShowCreate copyWith({ShowCreateObject? objType, ObjectName? objName}) =>
      ShowCreate(
...
class SqlExplainTable implements SqlAst, ToJsonSerializable {
  ...
  const SqlExplainTable({required this.describeAlias, required this.tableName});
  ...
  factory SqlExplainTable.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final describeAlias, final tableName) => SqlExplainTable(
        describeAlias: describeAlias! as bool,
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlExplainTable copyWith({bool? describeAlias, ObjectName? tableName}) =>
      SqlExplainTable(
        describeAlias: describeAlias ?? this.describeAlias,
...
class RenameTable implements AlterTableOperation, ToJsonSerializable {
  final ObjectName tableName;
  const RenameTable({required this.tableName});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  RenameTable copyWith({ObjectName? tableName}) =>
...
class SwapWith implements AlterTableOperation, ToJsonSerializable {
  final ObjectName tableName;
  const SwapWith({required this.tableName});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SwapWith copyWith({ObjectName? tableName}) =>
...
class CustomDataType implements ToJsonSerializable {
  ...
  const CustomDataType({required this.name, required this.arguments});
  ...
  factory CustomDataType.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final arguments) => CustomDataType(
        name: (name! as Iterable).map(Ident.fromJson).toList(),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  CustomDataType copyWith({ObjectName? name, List<String>? arguments}) =>
      CustomDataType(
        name: name ?? this.name,
  ...
  factory DataType.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) || [0, final value] => DataTypeCharacter(
        Option.fromJson(value, (some) => CharacterLength.fromJson(some)).value,
      ),
      ...
      (13, final value) ||
      [13, final value] => DataTypeNumeric(ExactNumberInfo.fromJson(value)),
      (14, final value) ||
      [14, final value] => DataTypeDecimal(ExactNumberInfo.fromJson(value)),
      (15, final value) ||
      [15, final value] => DataTypeBigNumeric(ExactNumberInfo.fromJson(value)),
      (16, final value) ||
      [16, final value] => DataTypeBigDecimal(ExactNumberInfo.fromJson(value)),
      (17, final value) ||
      [17, final value] => DataTypeDec(ExactNumberInfo.fromJson(value)),
      ...
      (36, final value) ||
      [36, final value] => DataTypeTime(TimestampType.fromJson(value)),
      (37, final value) || [37, final value] => DataTypeDatetime(
        Option.fromJson(value, (some) => bigIntFromJson(some)).value,
      ),
      (38, final value) ||
      [38, final value] => DataTypeTimestamp(TimestampType.fromJson(value)),
      ...
      (45, final value) ||
      [45, final value] => DataTypeCustom(CustomDataType.fromJson(value)),
      ...
      (48, final value) || [48, final value] => DataTypeSet(
        (value! as Iterable)
            .map((e) => e is String ? e : (e! as ParsedString).value)
            .toList(),
      ),
...
class DataTypeNumeric implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeNumeric',
    'numeric': value.toJson(),
  };
...
class DataTypeDecimal implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeDecimal',
    'decimal': value.toJson(),
  };
...
class DataTypeBigNumeric implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeBigNumeric',
    'big-numeric': value.toJson(),
  };
...
class DataTypeBigDecimal implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeBigDecimal',
    'big-decimal': value.toJson(),
  };
...
class DataTypeDoublePrecision implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeDoublePrecision',
...
class DataTypeTimestamp implements DataType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'DataTypeTimestamp',
    'timestamp': value.toJson(),
  };
...
class SqlPrepare implements ToJsonSerializable {
  ...
  factory SqlPrepare.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final dataTypes, final statement) => SqlPrepare(
        name: Ident.fromJson(name),
...
class ProcedureParam implements ToJsonSerializable {
  ...
  const ProcedureParam({required this.name, required this.dataType});
  ...
  factory ProcedureParam.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final dataType) => ProcedureParam(
        name: Ident.fromJson(name),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ProcedureParam copyWith({Ident? name, DataType? dataType}) => ProcedureParam(
    name: name ?? this.name,
...
class CreateProcedure implements SqlAst, ToJsonSerializable {
  ...
  factory CreateProcedure.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final orAlter, final name, final params, final body) => CreateProcedure(
        orAlter: orAlter! as bool,
        name: (name! as Iterable).map(Ident.fromJson).toList(),
        params: Option.fromJson(
          params,
          (some) => (some! as Iterable).map(ProcedureParam.fromJson).toList(),
        ).value,
    ...
    return switch (json) {
      ...
      (
        ...
        collation: Option.fromJson(
          collation,
          (some) => (some! as Iterable).map(Ident.fromJson).toList(),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class CompositeUserDefinedType
  ...
  const CompositeUserDefinedType({required this.attributes});
...
sealed class UserDefinedTypeRepresentation implements ToJsonSerializable {
  ...
  factory UserDefinedTypeRepresentation.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => CompositeUserDefinedType.fromJson(value),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
...
class CreateType implements SqlAst, ToJsonSerializable {
  ...
  const CreateType({required this.name, required this.representation});
  ...
  factory CreateType.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final representation) => CreateType(
        name: (name! as Iterable).map(Ident.fromJson).toList(),
        representation: UserDefinedTypeRepresentation.fromJson(representation),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class RenameIndex implements AlterIndexOperation, ToJsonSerializable {
  ...
  const RenameIndex({required this.indexName});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  RenameIndex copyWith({ObjectName? indexName}) =>
  ...
  static const _spec = RecordType([
    (label: 'index-name', t: ListType(Ident._spec)),
  ]);
}
...
class AlterIndex implements SqlAst, ToJsonSerializable {
  ...
  const AlterIndex({required this.name, required this.operation});
  ...
  factory AlterIndex.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final operation) => AlterIndex(
        name: (name! as Iterable).map(Ident.fromJson).toList(),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AlterIndex copyWith({ObjectName? name, AlterIndexOperation? operation}) =>
      AlterIndex(
        name: name ?? this.name,
...
class NumberValue implements ToJsonSerializable {
  final String value;
  final bool long;
  const NumberValue({required this.value, required this.long});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  NumberValue copyWith({String? value, bool? long}) =>
...
class DollarQuotedString implements ToJsonSerializable {
  final String value;
  final String? tag;
  const DollarQuotedString({required this.value, this.tag});
  ...
  factory DollarQuotedString.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final value, final tag) => DollarQuotedString(
        value: value is String ? value : (value! as ParsedString).value,
        tag: Option.fromJson(
          tag,
          (some) => some is String ? some : (some! as ParsedString).value,
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DollarQuotedString copyWith({String? value, Option<String>? tag}) =>
      DollarQuotedString(
        value: value ?? this.value,
...
sealed class SqlValue implements Expr, ToJsonSerializable {
  ...
  factory SqlValue.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => SqlValueNumber(NumberValue.fromJson(value)),
      (1, final value) || [1, final value] => SqlValueSingleQuotedString(
        value is String ? value : (value! as ParsedString).value,
      ),
      (2, final value) || [2, final value] => SqlValueDollarQuotedString(
        DollarQuotedString.fromJson(value),
      ),
      (3, final value) || [3, final value] => SqlValueEscapedStringLiteral(
        value is String ? value : (value! as ParsedString).value,
      ),
      (4, final value) ||
      [4, final value] => SqlValueSingleQuotedByteStringLiteral(
        value is String ? value : (value! as ParsedString).value,
      ),
      (5, final value) ||
      [5, final value] => SqlValueDoubleQuotedByteStringLiteral(
        value is String ? value : (value! as ParsedString).value,
      ),
...
class SqlValueRawStringLiteral implements SqlValue {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SqlValueRawStringLiteral',
...
class SqlValueHexStringLiteral implements SqlValue {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SqlValueHexStringLiteral',
...
class SqlValuePlaceholder implements SqlValue {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SqlValuePlaceholder',
    'placeholder': value,
  };
...
class SqlValueUnQuotedString implements SqlValue {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SqlValueUnQuotedString',
    'un-quoted-string': value,
  };
...
class SetTransaction implements SqlAst, ToJsonSerializable {
  ...
  factory SetTransaction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final modes, final snapshot, final session) => SetTransaction(
        modes: (modes! as Iterable).map(TransactionMode.fromJson).toList(),
        snapshot: Option.fromJson(
          snapshot,
          (some) => SqlValue.fromJson(some),
        ).value,
...
class SqlOption implements ToJsonSerializable {
  ...
  const SqlOption({required this.name, required this.value});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlOption copyWith({Ident? name, SqlValue? value}) =>
...
class UniqueConstraint implements TableConstraint, ToJsonSerializable {
  ...
  factory UniqueConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final columns, final isPrimary) => UniqueConstraint(
  ...
  factory ForeignKeyOption.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        foreignTable: (foreignTable! as Iterable).map(Ident.fromJson).toList(),
        referredColumns: (referredColumns! as Iterable)
            .map(Ident.fromJson)
            .toList(),
        onDelete: Option.fromJson(
          onDelete,
          (some) => ReferentialAction.fromJson(some),
        ).value,
  ...
  factory IndexConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        name: Option.fromJson(name, (some) => Ident.fromJson(some)).value,
        indexType: Option.fromJson(
          indexType,
          (some) => IndexType.fromJson(some),
        ).value,
        columns: (columns! as Iterable).map(Ident.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
...
class FullTextOrSpatialConstraint
  ...
  factory FullTextOrSpatialConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        optIndexName: Option.fromJson(
          optIndexName,
          (some) => Ident.fromJson(some),
        ).value,
        columns: (columns! as Iterable).map(Ident.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
  ...
  FullTextOrSpatialConstraint copyWith({
    ...
    optIndexName: optIndexName != null ? optIndexName.value : this.optIndexName,
    columns: columns ?? this.columns,
  );
  @override
  bool operator ==(Object other) =>
...
class SetExprRef implements ToJsonSerializable {
  final int /*U32*/ index_;
  const SetExprRef({required this.index_});
  ...
  factory SetExprRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SetExprRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SetExprRef copyWith({int /*U32*/ ? index_}) =>
...
class SqlSelectRef implements SetExpr, ToJsonSerializable {
  final int /*U32*/ index_;
  const SqlSelectRef({required this.index_});
  ...
  factory SqlSelectRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SqlSelectRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlSelectRef copyWith({int /*U32*/ ? index_}) =>
...
class SqlQueryRef implements SetExpr, ToJsonSerializable {
  final int /*U32*/ index_;
  const SqlQueryRef({required this.index_});
  ...
  factory SqlQueryRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SqlQueryRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlQueryRef copyWith({int /*U32*/ ? index_}) =>
...
class SqlUpdateRef implements SetExpr, ToJsonSerializable {
  final int /*U32*/ index_;
  const SqlUpdateRef({required this.index_});
  ...
  factory SqlUpdateRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SqlUpdateRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlUpdateRef copyWith({int /*U32*/ ? index_}) =>
...
class SqlInsertRef implements SetExpr, ToJsonSerializable {
  final int /*U32*/ index_;
  const SqlInsertRef({required this.index_});
  ...
  factory SqlInsertRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => SqlInsertRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlInsertRef copyWith({int /*U32*/ ? index_}) =>
...
class SetOperation implements SetExpr, ToJsonSerializable {
  ...
  factory SetOperation.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final op, final setQuantifier, final left, final right) => SetOperation(
...
class LockClause implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.LockClause.html
  const LockClause({required this.lockType, this.of_, this.nonblock});
  ...
  factory LockClause.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final lockType, final of_, final nonblock) => LockClause(
        lockType: LockType.fromJson(lockType),
        of_: Option.fromJson(
          of_,
          (some) => (some! as Iterable).map(Ident.fromJson).toList(),
        ).value,
        nonblock: Option.fromJson(
          nonblock,
          (some) => NonBlock.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class TableWithJoinsRef implements ToJsonSerializable {
  final int /*U32*/ index_;
  const TableWithJoinsRef({required this.index_});
  ...
  factory TableWithJoinsRef.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final index_] ||
      (final index_,) => TableWithJoinsRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TableWithJoinsRef copyWith({int /*U32*/ ? index_}) =>
...
class Table implements SetExpr, ToJsonSerializable {
  ...
  const Table({this.tableName, this.schemaName});
  ...
  factory Table.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final tableName, final schemaName) => Table(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Table copyWith({Option<String>? tableName, Option<String>? schemaName}) =>
      Table(
...
class Asterisk implements ToJsonSerializable {
  ...
  @override
  Map<String, Object?> toJson() => {'runtimeType': 'Asterisk'};
...
class QualifiedWildcard implements ToJsonSerializable {
  ...
  const QualifiedWildcard({required this.qualifier, required this.asterisk});
  ...
  factory QualifiedWildcard.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final qualifier, final asterisk) => QualifiedWildcard(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  QualifiedWildcard copyWith({ObjectName? qualifier, Asterisk? asterisk}) =>
      QualifiedWildcard(
...
class SelectInto implements ToJsonSerializable {
  ...
  factory SelectInto.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final temporary, final unlogged, final table, final name) => SelectInto(
...
class TableAlias implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.TableAlias.html
  const TableAlias({required this.name, required this.columns});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TableAlias copyWith({Ident? name, List<Ident>? columns}) =>
...
class TableFactorDerived implements TableFactor, ToJsonSerializable {
  ...
  factory TableFactorDerived.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final lateral, final subquery, final alias) => TableFactorDerived(
        lateral: lateral! as bool,
        subquery: SqlQueryRef.fromJson(subquery),
        alias: Option.fromJson(
          alias,
          (some) => TableAlias.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class TableFactorNestedJoin implements TableFactor, ToJsonSerializable {
  ...
  final TableAlias? alias;
  const TableFactorNestedJoin({required this.tableWithJoins, this.alias});
  ...
  factory TableFactorNestedJoin.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final tableWithJoins, final alias) => TableFactorNestedJoin(
...
class CommonTableExpr implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.Cte.html
  const CommonTableExpr({required this.alias, required this.query, this.from});
  ...
  factory CommonTableExpr.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final alias, final query, final from) => CommonTableExpr(
...
class With implements ToJsonSerializable {
  ...
  const With({required this.recursive, required this.cteTables});
  ...
  factory With.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final recursive, final cteTables) => With(
        recursive: recursive! as bool,
        cteTables: (cteTables! as Iterable)
            .map(CommonTableExpr.fromJson)
            .toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  List<Object?> toWasm() => [
    recursive,
    cteTables.map((e) => e.toWasm()).toList(growable: false),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  With copyWith({bool? recursive, List<CommonTableExpr>? cteTables}) => With(
...
class ExprRef implements ToJsonSerializable {
  final int /*U32*/ index_;
  const ExprRef({required this.index_});
  ...
  factory ExprRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => ExprRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  Map<String, Object?> toJson() => {'runtimeType': 'ExprRef', 'index': index_};
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ExprRef copyWith({int /*U32*/ ? index_}) =>
...
class ArrayExpr implements Expr, ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.Array.html
  const ArrayExpr({required this.elem, required this.named});
  ...
  /// Returns this as a WASM canonical abi value.
  List<Object?> toWasm() => [
    elem.map((e) => e.toWasm()).toList(growable: false),
    named,
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ArrayExpr copyWith({List<ExprRef>? elem, bool? named}) =>
...
class GroupingSets implements Expr, ToJsonSerializable {
  ...
  const GroupingSets({required this.values});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  GroupingSets copyWith({List<List<ExprRef>>? values}) =>
  ...
  static const _spec = RecordType([
    (label: 'values', t: ListType(ListType(ExprRef._spec))),
  ]);
}

class CubeExpr implements Expr, ToJsonSerializable {
  final List<List<ExprRef>> values;
  const CubeExpr({required this.values});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  CubeExpr copyWith({List<List<ExprRef>>? values}) =>
...
class RollupExpr implements Expr, ToJsonSerializable {
  final List<List<ExprRef>> values;
  const RollupExpr({required this.values});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  RollupExpr copyWith({List<List<ExprRef>>? values}) =>
...
class TupleExpr implements Expr, ToJsonSerializable {
  ...
  const TupleExpr({required this.values});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TupleExpr copyWith({List<ExprRef>? values}) =>
  ...
  List<Object?> get _props => [values];
  static const _spec = RecordType([
    (label: 'values', t: ListType(ExprRef._spec)),
  ]);
}
...
class ArrayIndex implements Expr, ToJsonSerializable {
  ...
  const ArrayIndex({required this.obj, required this.indexes});
  ...
  List<Object?> toWasm() => [
    obj.toWasm(),
    indexes.map((e) => e.toWasm()).toList(growable: false),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ArrayIndex copyWith({ExprRef? obj, List<ExprRef>? indexes}) =>
...
class MatchAgainst implements Expr, ToJsonSerializable {
  ...
  Map<String, Object?> toJson() => {
    ...
    'opt-search-modifier': (optSearchModifier == null
        ? const None().toJson()
        : Option.fromValue(optSearchModifier).toJson((some) => some.toJson())),
  };
  ...
  List<Object?> toWasm() => [
    ...
    (optSearchModifier == null
        ? const None().toWasm()
        : Option.fromValue(optSearchModifier).toWasm((some) => some.toWasm())),
  ];
  @override
  String toString() =>
...
class AggregateExpressionWithFilter implements Expr, ToJsonSerializable {
  ...
  factory AggregateExpressionWithFilter.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final filter) => AggregateExpressionWithFilter(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AggregateExpressionWithFilter copyWith({ExprRef? expr, ExprRef? filter}) =>
  ...
  static const _spec = RecordType([
    ...
    (label: 'filter', t: ExprRef._spec),
  ]);
}

class ArraySubquery implements Expr, ToJsonSerializable {
  final SqlQueryRef query;
  const ArraySubquery({required this.query});
  ...
  factory ArraySubquery.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final query] ||
      (final query,) => ArraySubquery(query: SqlQueryRef.fromJson(query)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ArraySubquery copyWith({SqlQueryRef? query}) =>
...
class ArrayAggRef implements Expr, ToJsonSerializable {
  final int /*U32*/ index_;
  const ArrayAggRef({required this.index_});
  ...
  factory ArrayAggRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => ArrayAggRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ArrayAggRef copyWith({int /*U32*/ ? index_}) =>
...
class ListAggRef implements Expr, ToJsonSerializable {
  final int /*U32*/ index_;
  const ListAggRef({required this.index_});
  ...
  factory ListAggRef.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final index_] || (final index_,) => ListAggRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ListAggRef copyWith({int /*U32*/ ? index_}) =>
...
class SqlFunctionRef implements Expr, ToJsonSerializable {
  final int /*U32*/ index_;
  const SqlFunctionRef({required this.index_});
  ...
  factory SqlFunctionRef.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final index_] ||
      (final index_,) => SqlFunctionRef(index_: index_! as int),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlFunctionRef copyWith({int /*U32*/ ? index_}) =>
...
class AtTimeZone implements Expr, ToJsonSerializable {
  ...
  const AtTimeZone({required this.timestamp, required this.timeZone});
  ...
  factory AtTimeZone.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final timestamp, final timeZone) => AtTimeZone(
        timestamp: ExprRef.fromJson(timestamp),
        timeZone: timeZone is String
            ? timeZone
            : (timeZone! as ParsedString).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AtTimeZone copyWith({ExprRef? timestamp, String? timeZone}) => AtTimeZone(
...
class Position implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final ExprRef in_;
  const Position({required this.expr, required this.in_});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Position copyWith({ExprRef? expr, ExprRef? in_}) =>
...
class Substring implements Expr, ToJsonSerializable {
  ...
  const Substring({required this.expr, this.substringFrom, this.substringFor});
  ...
  factory Substring.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final substringFrom, final substringFor) => Substring(
        expr: ExprRef.fromJson(expr),
        substringFrom: Option.fromJson(
          substringFrom,
          (some) => ExprRef.fromJson(some),
        ).value,
        substringFor: Option.fromJson(
          substringFor,
          (some) => ExprRef.fromJson(some),
        ).value,
      ),
  ...
  Substring copyWith({
    ...
    expr: expr ?? this.expr,
    substringFrom: substringFrom != null
        ? substringFrom.value
        : this.substringFrom,
    substringFor: substringFor != null ? substringFor.value : this.substringFor,
  );
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class IntervalExpr implements Expr, ToJsonSerializable {
    ...
    return switch (json) {
      ...
      (
        ...
        leadingField: Option.fromJson(
          leadingField,
          (some) => DateTimeField.fromJson(some),
        ).value,
        leadingPrecision: Option.fromJson(
          leadingPrecision,
          (some) => bigIntFromJson(some),
        ).value,
        lastField: Option.fromJson(
          lastField,
          (some) => DateTimeField.fromJson(some),
        ).value,
  ...
  Map<String, Object?> toJson() => {
    ...
    'leading-precision': (leadingPrecision == null
        ? const None().toJson()
        : Option.fromValue(leadingPrecision).toJson((some) => some.toString())),
  ...
  IntervalExpr copyWith({
    ...
    value: value ?? this.value,
    leadingField: leadingField != null ? leadingField.value : this.leadingField,
...
class Extract implements Expr, ToJsonSerializable {
  ...
  final ExprRef expr;
  const Extract({required this.field, required this.expr});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Extract copyWith({DateTimeField? field, ExprRef? expr}) =>
...
class Ceil implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final DateTimeField field;
  const Ceil({required this.expr, required this.field});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Ceil copyWith({ExprRef? expr, DateTimeField? field}) =>
...
class Floor implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final DateTimeField field;
  const Floor({required this.expr, required this.field});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Floor copyWith({ExprRef? expr, DateTimeField? field}) =>
...
class Trim implements Expr, ToJsonSerializable {
  ...
  const Trim({required this.expr, this.trimWhere, this.trimWhat});
  ...
  factory Trim.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final trimWhere, final trimWhat) => Trim(
        expr: ExprRef.fromJson(expr),
        trimWhere: Option.fromJson(
          trimWhere,
          (some) => TrimWhereField.fromJson(some),
        ).value,
        trimWhat: Option.fromJson(
          trimWhat,
          (some) => ExprRef.fromJson(some),
        ).value,
      ),
...
class Collate implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final ObjectName collation;
  const Collate({required this.expr, required this.collation});
  ...
  List<Object?> toWasm() => [
    expr.toWasm(),
    collation.map((e) => e.toWasm()).toList(growable: false),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Collate copyWith({ExprRef? expr, ObjectName? collation}) =>
...
class IntroducedString implements Expr, ToJsonSerializable {
  ...
  final SqlValue value;
  const IntroducedString({required this.introducer, required this.value});
  ...
  factory IntroducedString.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final introducer, final value) => IntroducedString(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  IntroducedString copyWith({String? introducer, SqlValue? value}) =>
      IntroducedString(
...
class TypedString implements Expr, ToJsonSerializable {
  final DataType dataType;
  final String value;
  const TypedString({required this.dataType, required this.value});
  ...
  factory TypedString.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final dataType, final value) => TypedString(
        dataType: DataType.fromJson(dataType),
        value: value is String ? value : (value! as ParsedString).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TypedString copyWith({DataType? dataType, String? value}) => TypedString(
    dataType: dataType ?? this.dataType,
    value: value ?? this.value,
  );
  @override
...
class MapAccess implements Expr, ToJsonSerializable {
  ...
  const MapAccess({required this.column, required this.keys});
  ...
  List<Object?> toWasm() => [
    column.toWasm(),
    keys.map((e) => e.toWasm()).toList(growable: false),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  MapAccess copyWith({ExprRef? column, List<ExprRef>? keys}) =>
...
class JsonAccess implements Expr, ToJsonSerializable {
  ...
  factory JsonAccess.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final left, final operator_, final right) => JsonAccess(
...
class CompositeAccess implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final Ident key;
  const CompositeAccess({required this.expr, required this.key});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  CompositeAccess copyWith({ExprRef? expr, Ident? key}) =>
...
class InList implements Expr, ToJsonSerializable {
  ...
  factory InList.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final list, final negated) => InList(
        expr: ExprRef.fromJson(expr),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  InList copyWith({ExprRef? expr, List<ExprRef>? list, bool? negated}) =>
      InList(
        expr: expr ?? this.expr,
        list: list ?? this.list,
...
class InSubquery implements Expr, ToJsonSerializable {
  ...
  factory InSubquery.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final subquery, final negated) => InSubquery(
        expr: ExprRef.fromJson(expr),
        subquery: SqlQueryRef.fromJson(subquery),
        negated: negated! as bool,
      ),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  InSubquery copyWith({ExprRef? expr, SqlQueryRef? subquery, bool? negated}) =>
      InSubquery(
        expr: expr ?? this.expr,
        subquery: subquery ?? this.subquery,
        negated: negated ?? this.negated,
...
class InUnnest implements Expr, ToJsonSerializable {
  ...
  factory InUnnest.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final arrayExpr, final negated) => InUnnest(
        expr: ExprRef.fromJson(expr),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  InUnnest copyWith({ExprRef? expr, ExprRef? arrayExpr, bool? negated}) =>
      InUnnest(
        expr: expr ?? this.expr,
...
class Between implements Expr, ToJsonSerializable {
  ...
  factory Between.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final negated, final low, final high) => Between(
        expr: ExprRef.fromJson(expr),
        negated: negated! as bool,
...
class Like implements Expr, ToJsonSerializable {
  ...
  factory Like.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final negated, final expr, final pattern, final escapeChar) => Like(
        negated: negated! as bool,
        expr: ExprRef.fromJson(expr),
        pattern: ExprRef.fromJson(pattern),
        escapeChar: Option.fromJson(
          escapeChar,
          (some) => some! as String,
        ).value,
      ),
...
class ILike implements Expr, ToJsonSerializable {
  ...
  factory ILike.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final negated, final expr, final pattern, final escapeChar] ||
      (final negated, final expr, final pattern, final escapeChar) => ILike(
        negated: negated! as bool,
        expr: ExprRef.fromJson(expr),
        pattern: ExprRef.fromJson(pattern),
        escapeChar: Option.fromJson(
...
class SimilarTo implements Expr, ToJsonSerializable {
  ...
  factory SimilarTo.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final negated, final expr, final pattern, final escapeChar] ||
      (final negated, final expr, final pattern, final escapeChar) => SimilarTo(
        negated: negated! as bool,
        expr: ExprRef.fromJson(expr),
        pattern: ExprRef.fromJson(pattern),
        escapeChar: Option.fromJson(
...
class Cast implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final DataType dataType;
  const Cast({required this.expr, required this.dataType});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Cast copyWith({ExprRef? expr, DataType? dataType}) =>
...
class TryCast implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final DataType dataType;
  const TryCast({required this.expr, required this.dataType});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TryCast copyWith({ExprRef? expr, DataType? dataType}) =>
...
class SafeCast implements Expr, ToJsonSerializable {
  final ExprRef expr;
  final DataType dataType;
  const SafeCast({required this.expr, required this.dataType});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SafeCast copyWith({ExprRef? expr, DataType? dataType}) =>
...
class AnyOp implements Expr, ToJsonSerializable {
  final ExprRef expr;
  const AnyOp({required this.expr});
  ...
  factory AnyOp.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final expr] || (final expr,) => AnyOp(expr: ExprRef.fromJson(expr)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AnyOp copyWith({ExprRef? expr}) => AnyOp(expr: expr ?? this.expr);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AnyOp &&
...
class AllOp implements Expr, ToJsonSerializable {
  final ExprRef expr;
  const AllOp({required this.expr});
  ...
  factory AllOp.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final expr] || (final expr,) => AllOp(expr: ExprRef.fromJson(expr)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AllOp copyWith({ExprRef? expr}) => AllOp(expr: expr ?? this.expr);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AllOp &&
...
class Exists implements Expr, ToJsonSerializable {
  final SqlQueryRef subquery;
  final bool negated;
  const Exists({required this.subquery, required this.negated});
  ...
  factory Exists.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final subquery, final negated) => Exists(
        subquery: SqlQueryRef.fromJson(subquery),
        negated: negated! as bool,
      ),
      _ => throw Exception('Invalid JSON $json_'),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Exists copyWith({SqlQueryRef? subquery, bool? negated}) => Exists(
    subquery: subquery ?? this.subquery,
    negated: negated ?? this.negated,
  );
  @override
...
class NestedExpr implements Expr, ToJsonSerializable {
  final ExprRef expr;
  const NestedExpr({required this.expr});
  ...
  factory NestedExpr.fromJson(Object? json_) {
    final json = json_ is Map
        ...
        : json_;
    return switch (json) {
      [final expr] || (final expr,) => NestedExpr(expr: ExprRef.fromJson(expr)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  NestedExpr copyWith({ExprRef? expr}) => NestedExpr(expr: expr ?? this.expr);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is NestedExpr &&
...
class Subquery implements Expr, ToJsonSerializable {
  final SqlQueryRef query;
  const Subquery({required this.query});
  ...
  factory Subquery.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final query] ||
      (final query,) => Subquery(query: SqlQueryRef.fromJson(query)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Subquery copyWith({SqlQueryRef? query}) =>
...
sealed class BinaryOperator implements ToJsonSerializable {
  ...
  factory BinaryOperator.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (30, final value) ||
      [30, final value] => BinaryOperatorPgCustomBinaryOperator(
        (value! as Iterable)
            .map((e) => e is String ? e : (e! as ParsedString).value)
            .toList(),
      ),
...
class BinaryOperatorPlus implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorPlus',
    'plus': null,
  };
...
class BinaryOperatorMinus implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorMinus',
    'minus': null,
  };
...
class BinaryOperatorMultiply implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorMultiply',
    'multiply': null,
  };
...
class BinaryOperatorDivide implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorDivide',
    'divide': null,
  };
...
class BinaryOperatorModulo implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorModulo',
    'modulo': null,
  };
...
class BinaryOperatorStringConcat implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorStringConcat',
    'string-concat': null,
  };
...
class BinaryOperatorGtEq implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorGtEq',
    'gt-eq': null,
  };
...
class BinaryOperatorLtEq implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorLtEq',
    'lt-eq': null,
  };
...
class BinaryOperatorSpaceship implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorSpaceship',
    'spaceship': null,
  };
...
class BinaryOperatorNotEq implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorNotEq',
    'not-eq': null,
  };
...
class BinaryOperatorBitwiseOr implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorBitwiseOr',
    'bitwise-or': null,
  };
...
class BinaryOperatorBitwiseAnd implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorBitwiseAnd',
    'bitwise-and': null,
  };
...
class BinaryOperatorBitwiseXor implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorBitwiseXor',
    'bitwise-xor': null,
  };
...
class BinaryOperatorCustom implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorCustom',
    'custom': value,
  };
...
class BinaryOperatorPgBitwiseXor implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorPgBitwiseXor',
    'pg-bitwise-xor': null,
  };
...
class BinaryOperatorPgExp implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorPgExp',
    'pg-exp': null,
  };
...
class BinaryOperatorPgRegexMatch implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorPgRegexMatch',
    'pg-regex-match': null,
  };
...
class BinaryOperatorPgRegexIMatch implements BinaryOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'BinaryOperatorPgRegexIMatch',
    'pg-regex-i-match': null,
  };
...
class BinaryOp implements Expr, ToJsonSerializable {
  ...
  factory BinaryOp.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final left, final op, final right) => BinaryOp(
        left: ExprRef.fromJson(left),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  BinaryOp copyWith({ExprRef? left, BinaryOperator? op, ExprRef? right}) =>
      BinaryOp(
        left: left ?? this.left,
        op: op ?? this.op,
        right: right ?? this.right,
...
class BoolUnaryOp implements Expr, ToJsonSerializable {
  ...
  final ExprRef expr;
  const BoolUnaryOp({required this.op, required this.expr});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  BoolUnaryOp copyWith({BoolUnaryOperator? op, ExprRef? expr}) =>
...
class UnaryOp implements Expr, ToJsonSerializable {
  ...
  final ExprRef expr;
  const UnaryOp({required this.op, required this.expr});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  UnaryOp copyWith({UnaryOperator? op, ExprRef? expr}) =>
...
class IsDistinctFrom implements Expr, ToJsonSerializable {
  final ExprRef left;
  final ExprRef right;
  const IsDistinctFrom({required this.left, required this.right});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  IsDistinctFrom copyWith({ExprRef? left, ExprRef? right}) =>
...
class IsNotDistinctFrom implements Expr, ToJsonSerializable {
  final ExprRef left;
  final ExprRef right;
  const IsNotDistinctFrom({required this.left, required this.right});
  ...
  factory IsNotDistinctFrom.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final left, final right) => IsNotDistinctFrom(
        left: ExprRef.fromJson(left),
        right: ExprRef.fromJson(right),
      ),
      _ => throw Exception('Invalid JSON $json_'),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  IsNotDistinctFrom copyWith({ExprRef? left, ExprRef? right}) =>
...
sealed class Expr implements ToJsonSerializable {
  ...
  factory Expr.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (34, final value) ||
      [34, final value] => IntroducedString.fromJson(value),
      ...
      (50, final value) ||
      [50, final value] => AggregateExpressionWithFilter.fromJson(value),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class SqlAnalyze implements SqlAst, ToJsonSerializable {
  ...
  factory SqlAnalyze.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        tableName: (tableName! as Iterable).map(Ident.fromJson).toList(),
        partitions: Option.fromJson(
          partitions,
          (some) => (some! as Iterable).map(Expr.fromJson).toList(),
        ).value,
  ...
  List<Object?> toWasm() => [
    ...
    (partitions == null
        ...
        : Option.fromValue(
            partitions,
          ).toWasm((some) => some.map(Expr.toWasm).toList(growable: false))),
    forColumns,
    columns.map((e) => e.toWasm()).toList(growable: false),
    cacheMetadata,
    noscan,
...
sealed class ShowStatementFilter implements ToJsonSerializable {
  ...
  factory ShowStatementFilter.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (2, final value) ||
      [2, final value] => ShowStatementFilterWhere(Expr.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class ShowStatementFilterLike implements ShowStatementFilter {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ShowStatementFilterLike',
    'like': value,
  };
...
class ShowStatementFilterILike implements ShowStatementFilter {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ShowStatementFilterILike',
    'i-like': value,
  };
...
class ShowStatementFilterWhere implements ShowStatementFilter {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ShowStatementFilterWhere',
    'where': value.toJson(),
  };
...
class ShowFunctions implements SqlAst, ToJsonSerializable {
  ...
  const ShowFunctions({this.filter});
    ...
    return switch (json) {
      [final filter] || (final filter,) => ShowFunctions(
        filter: Option.fromJson(
          filter,
          (some) => ShowStatementFilter.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ShowFunctions copyWith({Option<ShowStatementFilter>? filter}) =>
...
class ShowVariables implements SqlAst, ToJsonSerializable {
  final ShowStatementFilter? filter;
  const ShowVariables({this.filter});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ShowVariables copyWith({Option<ShowStatementFilter>? filter}) =>
...
class ShowTables implements SqlAst, ToJsonSerializable {
  ...
  factory ShowTables.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final extended, final full, final dbName, final filter) => ShowTables(
        extended: extended! as bool,
        full: full! as bool,
...
class ShowCollation implements SqlAst, ToJsonSerializable {
  final ShowStatementFilter? filter;
  const ShowCollation({this.filter});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ShowCollation copyWith({Option<ShowStatementFilter>? filter}) =>
...
class MatchedDelete implements MergeClause, ToJsonSerializable {
  ...
  const MatchedDelete({this.predicate});
  ...
  factory MatchedDelete.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final predicate] || (final predicate,) => MatchedDelete(
        predicate: Option.fromJson(
          predicate,
          (some) => Expr.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  /// Returns a new instance by overriding the values passed as arguments
  MatchedDelete copyWith({Option<Expr>? predicate}) => MatchedDelete(
...
class SetVariable implements SqlAst, ToJsonSerializable {
  ...
  factory SetVariable.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final local, final hivevar, final variable, final value) => SetVariable(
        local: local! as bool,
...
class SqlAssert implements SqlAst, ToJsonSerializable {
  ...
  final Expr? message;
  const SqlAssert({required this.condition, this.message});
  ...
  factory SqlAssert.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final condition, final message) => SqlAssert(
        condition: Expr.fromJson(condition),
        message: Option.fromJson(message, (some) => Expr.fromJson(some)).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlAssert copyWith({Expr? condition, Option<Expr>? message}) => SqlAssert(
...
class SqlExecute implements SqlAst, ToJsonSerializable {
  ...
  const SqlExecute({required this.name, required this.parameters});
  ...
  factory SqlExecute.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final parameters) => SqlExecute(
        name: Ident.fromJson(name),
  ...
  List<Object?> toWasm() => [
    name.toWasm(),
    parameters.map(Expr.toWasm).toList(growable: false),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SqlExecute copyWith({Ident? name, List<Expr>? parameters}) => SqlExecute(
    name: name ?? this.name,
...
class OperateFunctionArg implements ToJsonSerializable {
  ...
  OperateFunctionArg copyWith({
    ...
    name: name != null ? name.value : this.name,
    dataType: dataType ?? this.dataType,
    defaultExpr: defaultExpr != null ? defaultExpr.value : this.defaultExpr,
  );
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class DropFunctionDesc implements ToJsonSerializable {
  ...
  const DropFunctionDesc({required this.name, this.args});
    ...
    return switch (json) {
      [final name, final args] || (final name, final args) => DropFunctionDesc(
        ...
        args: Option.fromJson(
          args,
          (some) =>
              (some! as Iterable).map(OperateFunctionArg.fromJson).toList(),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
class SqlDropFunction implements SqlAst, ToJsonSerializable {
  ...
  factory SqlDropFunction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final ifExists, final funcDesc, final option) => SqlDropFunction(
        ifExists: ifExists! as bool,
        funcDesc: (funcDesc! as Iterable)
            .map(DropFunctionDesc.fromJson)
            .toList(),
  ...
  factory CreateFunctionBody.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        language: Option.fromJson(
          language,
          (some) => Ident.fromJson(some),
        ).value,
        behavior: Option.fromJson(
          behavior,
          (some) => FunctionBehavior.fromJson(some),
        ).value,
        as_: Option.fromJson(
          as_,
          (some) => FunctionDefinition.fromJson(some),
        ).value,
        return_: Option.fromJson(return_, (some) => Expr.fromJson(some)).value,
        using: Option.fromJson(
          using,
          (some) => CreateFunctionUsing.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  factory CreateFunction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        returnType: Option.fromJson(
          returnType,
          (some) => DataType.fromJson(some),
        ).value,
...
class MacroArg implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.MacroArg.html
  const MacroArg({required this.name, this.defaultExpr});
  ...
  factory MacroArg.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final defaultExpr) => MacroArg(
        name: Ident.fromJson(name),
        defaultExpr: Option.fromJson(
          defaultExpr,
          (some) => Expr.fromJson(some),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  MacroArg copyWith({Ident? name, Option<Expr>? defaultExpr}) => MacroArg(
    name: name ?? this.name,
    defaultExpr: defaultExpr != null ? defaultExpr.value : this.defaultExpr,
  );
  @override
...
sealed class MinMaxValue implements ToJsonSerializable {
  ...
  factory MinMaxValue.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (2, final value) ||
      [2, final value] => MinMaxValueSome(Expr.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class IncrementBy implements ToJsonSerializable {
  ...
  final bool by;
  const IncrementBy({required this.increment, required this.by});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  IncrementBy copyWith({Expr? increment, bool? by}) =>
...
class StartWith implements ToJsonSerializable {
  final Expr start;
  final bool with_;
  const StartWith({required this.start, required this.with_});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  StartWith copyWith({Expr? start, bool? with_}) =>
...
sealed class SequenceOptions implements ToJsonSerializable {
  ...
  factory SequenceOptions.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) || [0, final value] => SequenceOptionsIncrementBy(
        IncrementBy.fromJson(value),
      ),
      (1, final value) ||
      [1, final value] => SequenceOptionsMinValue(MinMaxValue.fromJson(value)),
      (2, final value) ||
      [2, final value] => SequenceOptionsMaxValue(MinMaxValue.fromJson(value)),
      (3, final value) ||
      [3, final value] => SequenceOptionsStartWith(StartWith.fromJson(value)),
      (4, final value) ||
      [4, final value] => SequenceOptionsCache(Expr.fromJson(value)),
      (5, final value) ||
      [5, final value] => SequenceOptionsCycle(value! as bool),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class SequenceOptionsMinValue implements SequenceOptions {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SequenceOptionsMinValue',
    'min-value': value.toJson(),
  };
...
class SequenceOptionsMaxValue implements SequenceOptions {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SequenceOptionsMaxValue',
    'max-value': value.toJson(),
  };
...
class SequenceOptionsStartWith implements SequenceOptions {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SequenceOptionsStartWith',
    'start-with': value.toJson(),
  };
...
class SequenceOptionsCache implements SequenceOptions {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SequenceOptionsCache',
    'cache': value.toJson(),
  };
...
class SequenceOptionsCycle implements SequenceOptions {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SequenceOptionsCycle',
    'cycle': value,
  };
...
class GeneratedOption implements ToJsonSerializable {
  ...
  factory GeneratedOption.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        final generatedAs,
        final sequenceOptions,
        final generationExpr,
      ) => GeneratedOption(
        generatedAs: GeneratedAs.fromJson(generatedAs),
        sequenceOptions: Option.fromJson(
          sequenceOptions,
          (some) => (some! as Iterable).map(SequenceOptions.fromJson).toList(),
        ).value,
        generationExpr: Option.fromJson(
          generationExpr,
          (some) => Expr.fromJson(some),
        ).value,
      ),
...
sealed class ColumnOption implements ToJsonSerializable {
  ...
  factory ColumnOption.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (2, final value) ||
      [2, final value] => ColumnOptionDefault(Expr.fromJson(value)),
      (3, final value) ||
      [3, final value] => ColumnOptionUnique(UniqueOption.fromJson(value)),
      (4, final value) || [4, final value] => ColumnOptionForeignKey(
        ForeignKeyOption.fromJson(value),
      ),
      (5, final value) ||
      [5, final value] => ColumnOptionCheck(Expr.fromJson(value)),
      ...
      (9, final value) ||
      [9, final value] => ColumnOptionOnUpdate(Expr.fromJson(value)),
      (10, final value) || [10, final value] => ColumnOptionGenerated(
        GeneratedOption.fromJson(value),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class ColumnOptionNotNull implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionNotNull',
    'not-null': null,
  };
...
class ColumnOptionDefault implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionDefault',
...
class ColumnOptionUnique implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionUnique',
    'unique': value.toJson(),
  };
...
class ColumnOptionForeignKey implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionForeignKey',
    'foreign-key': value.toJson(),
  };
...
class ColumnOptionDialectSpecific implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionDialectSpecific',
    'dialect-specific': value,
  };
...
class ColumnOptionComment implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionComment',
    'comment': value,
  };
...
class ColumnOptionOnUpdate implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionOnUpdate',
    'on-update': value.toJson(),
  };
...
class ColumnOptionGenerated implements ColumnOption {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ColumnOptionGenerated',
    'generated': value.toJson(),
  };
...
class ColumnOptionDef implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.ColumnOptionDef.html
  const ColumnOptionDef({this.name, required this.option});
  ...
  factory ColumnOptionDef.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final option) => ColumnOptionDef(
        name: Option.fromJson(name, (some) => Ident.fromJson(some)).value,
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ColumnOptionDef copyWith({Option<Ident>? name, ColumnOption? option}) =>
      ColumnOptionDef(
        name: name != null ? name.value : this.name,
...
class ColumnDef implements ToJsonSerializable {
  ...
  factory ColumnDef.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final dataType, final collation, final options) => ColumnDef(
        name: Ident.fromJson(name),
        dataType: DataType.fromJson(dataType),
        collation: Option.fromJson(
          collation,
        ...
        options: (options! as Iterable).map(ColumnOptionDef.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class AddColumn implements AlterTableOperation, ToJsonSerializable {
  ...
  factory AddColumn.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final columnKeyword, final ifNotExists, final columnDef) => AddColumn(
...
class RenamePartitions implements AlterTableOperation, ToJsonSerializable {
  ...
  factory RenamePartitions.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final oldPartitions, final newPartitions) => RenamePartitions(
        oldPartitions: (oldPartitions! as Iterable).map(Expr.fromJson).toList(),
        newPartitions: (newPartitions! as Iterable).map(Expr.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class AddPartitions implements AlterTableOperation, ToJsonSerializable {
  final bool ifNotExists;
  final List<Expr> newPartitions;
  const AddPartitions({required this.ifNotExists, required this.newPartitions});
  ...
  factory AddPartitions.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final ifNotExists, final newPartitions) => AddPartitions(
        ifNotExists: ifNotExists! as bool,
        newPartitions: (newPartitions! as Iterable).map(Expr.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AddPartitions copyWith({bool? ifNotExists, List<Expr>? newPartitions}) =>
      AddPartitions(
        ifNotExists: ifNotExists ?? this.ifNotExists,
        newPartitions: newPartitions ?? this.newPartitions,
      );
...
class DropPartitions implements AlterTableOperation, ToJsonSerializable {
  final List<Expr> partitions;
  final bool ifExists;
  const DropPartitions({required this.partitions, required this.ifExists});
  ...
  factory DropPartitions.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final partitions, final ifExists) => DropPartitions(
  ...
  /// Returns this as a WASM canonical abi value.
  List<Object?> toWasm() => [
    partitions.map(Expr.toWasm).toList(growable: false),
    ifExists,
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DropPartitions copyWith({List<Expr>? partitions, bool? ifExists}) =>
      DropPartitions(
...
class SetDataType implements ToJsonSerializable {
  final DataType dataType;
  final Expr? using;
  const SetDataType({required this.dataType, this.using});
  ...
  factory SetDataType.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final dataType, final using) => SetDataType(
        dataType: DataType.fromJson(dataType),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SetDataType copyWith({DataType? dataType, Option<Expr>? using}) =>
      SetDataType(
        dataType: dataType ?? this.dataType,
        using: using != null ? using.value : this.using,
      );
...
class SetDefault implements ToJsonSerializable {
  final Expr value;
  const SetDefault({required this.value});
  ...
  factory SetDefault.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final value] ||
      (final value,) => SetDefault(value: Expr.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  @override
  ...
  /// Returns a new instance by overriding the values passed as arguments
  SetDefault copyWith({Expr? value}) => SetDefault(value: value ?? this.value);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SetDefault &&
...
sealed class AlterColumnOperation implements ToJsonSerializable {
  ...
  factory AlterColumnOperation.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (3, final value) || [3, final value] => AlterColumnOperationSetDataType(
        SetDataType.fromJson(value),
      ),
      (4, final value) || [4, final value] => AlterColumnOperationSetDefault(
        SetDefault.fromJson(value),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class AlterColumnOperationSetNotNull implements AlterColumnOperation {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'AlterColumnOperationSetNotNull',
    'set-not-null': null,
  };
...
class AlterColumnOperationDropNotNull implements AlterColumnOperation {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'AlterColumnOperationDropNotNull',
    'drop-not-null': null,
  };
...
class AlterColumnOperationDropDefault implements AlterColumnOperation {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'AlterColumnOperationDropDefault',
    'drop-default': null,
  };
...
class AlterColumn implements AlterTableOperation, ToJsonSerializable {
  ...
  const AlterColumn({required this.columnName, required this.op});
  ...
  factory AlterColumn.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final columnName, final op) => AlterColumn(
        columnName: Ident.fromJson(columnName),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AlterColumn copyWith({Ident? columnName, AlterColumnOperation? op}) =>
...
class CheckConstraint implements TableConstraint, ToJsonSerializable {
  final Ident? name;
  final Expr expr;
  const CheckConstraint({this.name, required this.expr});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  CheckConstraint copyWith({Option<Ident>? name, Expr? expr}) =>
      CheckConstraint(
        name: name != null ? name.value : this.name,
        expr: expr ?? this.expr,
      );
...
class AddConstraint implements AlterTableOperation, ToJsonSerializable {
  ...
  const AddConstraint({required this.constraint});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AddConstraint copyWith({TableConstraint? constraint}) =>
  ...
  static const _spec = RecordType([
    (label: 'constraint', t: TableConstraint._spec),
  ]);
}
...
sealed class AlterTableOperation implements ToJsonSerializable {
  ...
  factory AlterTableOperation.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (11, final value) ||
      [11, final value] => RenameConstraint.fromJson(value),
...
class AlterTable implements SqlAst, ToJsonSerializable {
  ...
  const AlterTable({required this.name, required this.operation});
  ...
  factory AlterTable.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final name, final operation] ||
      (final name, final operation) => AlterTable(
        name: (name! as Iterable).map(Ident.fromJson).toList(),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  AlterTable copyWith({ObjectName? name, AlterTableOperation? operation}) =>
      AlterTable(
        name: name ?? this.name,
        operation: operation ?? this.operation,
      );
...
class Values implements SetExpr, ToJsonSerializable {
  ...
  const Values({required this.explicitRow, required this.rows});
  ...
  factory Values.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final explicitRow, final rows) => Values(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Values copyWith({bool? explicitRow, List<List<Expr>>? rows}) => Values(
...
class NotMatched implements MergeClause, ToJsonSerializable {
  ...
  factory NotMatched.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final predicate, final columns, final values) => NotMatched(
        predicate: Option.fromJson(
          predicate,
          (some) => Expr.fromJson(some),
        ).value,
...
class Fetch implements ToJsonSerializable {
  ...
  factory Fetch.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final withTies, final percent, final quantity) => Fetch(
        withTies: withTies! as bool,
        percent: percent! as bool,
        quantity: Option.fromJson(
          quantity,
          (some) => Expr.fromJson(some),
        ).value,
      ),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Fetch copyWith({bool? withTies, bool? percent, Option<Expr>? quantity}) =>
      Fetch(
...
class Offset implements ToJsonSerializable {
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Offset copyWith({Expr? value, OffsetRows? rows}) =>
...
class TableFactorTableFunction implements TableFactor, ToJsonSerializable {
  final Expr expr;
  final TableAlias? alias;
  const TableFactorTableFunction({required this.expr, this.alias});
  ...
  factory TableFactorTableFunction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final alias) => TableFactorTableFunction(
        expr: Expr.fromJson(expr),
        alias: Option.fromJson(
          alias,
          (some) => TableAlias.fromJson(some),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TableFactorTableFunction copyWith({Expr? expr, Option<TableAlias>? alias}) =>
...
class TableFactorUnnest implements TableFactor, ToJsonSerializable {
  ...
  factory TableFactorUnnest.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        withOffsetAlias: Option.fromJson(
          withOffsetAlias,
          (some) => Ident.fromJson(some),
        ).value,
      ),
  ...
  Map<String, Object?> toJson() => {
    ...
    'with-offset-alias': (withOffsetAlias == null
        ? const None().toJson()
        : Option.fromValue(withOffsetAlias).toJson((some) => some.toJson())),
  };
  ...
  factory TableFactorPivot.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        name: (name! as Iterable).map(Ident.fromJson).toList(),
        tableAlias: Option.fromJson(
          tableAlias,
          (some) => TableAlias.fromJson(some),
        ).value,
        aggregateFunction: Expr.fromJson(aggregateFunction),
        valueColumn: (valueColumn! as Iterable).map(Ident.fromJson).toList(),
        pivotValues: (pivotValues! as Iterable).map(SqlValue.fromJson).toList(),
        pivotAlias: Option.fromJson(
          pivotAlias,
          (some) => TableAlias.fromJson(some),
        ).value,
      ),
...
sealed class JoinConstraint implements ToJsonSerializable {
  ...
  factory JoinConstraint.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => JoinConstraintOn(Expr.fromJson(value)),
      (1, final value) || [1, final value] => JoinConstraintUsing(
        (value! as Iterable).map(Ident.fromJson).toList(),
      ),
...
class JoinConstraintNatural implements JoinConstraint {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinConstraintNatural',
    'natural': null,
  };
...
class JoinConstraintNone implements JoinConstraint {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinConstraintNone',
    'none': null,
  };
...
sealed class JoinOperator implements ToJsonSerializable {
  ...
  factory JoinOperator.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => JoinOperatorInner(JoinConstraint.fromJson(value)),
      (1, final value) ||
      [1, final value] => JoinOperatorLeftOuter(JoinConstraint.fromJson(value)),
      (2, final value) || [2, final value] => JoinOperatorRightOuter(
        JoinConstraint.fromJson(value),
      ),
      (3, final value) ||
      [3, final value] => JoinOperatorFullOuter(JoinConstraint.fromJson(value)),
      (4, null) || [4, null] => const JoinOperatorCrossJoin(),
      (5, final value) ||
      [5, final value] => JoinOperatorLeftSemi(JoinConstraint.fromJson(value)),
      (6, final value) ||
      [6, final value] => JoinOperatorRightSemi(JoinConstraint.fromJson(value)),
      (7, final value) ||
      [7, final value] => JoinOperatorLeftAnti(JoinConstraint.fromJson(value)),
      (8, final value) ||
      [8, final value] => JoinOperatorRightAnti(JoinConstraint.fromJson(value)),
...
class JoinOperatorLeftOuter implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorLeftOuter',
    'left-outer': value.toJson(),
  };
...
class JoinOperatorRightOuter implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorRightOuter',
    'right-outer': value.toJson(),
  };
...
class JoinOperatorFullOuter implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorFullOuter',
    'full-outer': value.toJson(),
  };
...
class JoinOperatorCrossJoin implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorCrossJoin',
    'cross-join': null,
  };
...
class JoinOperatorLeftSemi implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorLeftSemi',
    'left-semi': value.toJson(),
  };
...
class JoinOperatorRightSemi implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorRightSemi',
    'right-semi': value.toJson(),
  };
...
class JoinOperatorLeftAnti implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorLeftAnti',
    'left-anti': value.toJson(),
  };
...
class JoinOperatorRightAnti implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorRightAnti',
    'right-anti': value.toJson(),
  };
...
class JoinOperatorCrossApply implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorCrossApply',
    'cross-apply': null,
  };
...
class JoinOperatorOuterApply implements JoinOperator {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'JoinOperatorOuterApply',
    'outer-apply': null,
  };
  ...
  factory LateralView.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        lateralViewName: (lateralViewName! as Iterable)
            .map(Ident.fromJson)
            .toList(),
        lateralColAlias: (lateralColAlias! as Iterable)
            .map(Ident.fromJson)
            .toList(),
        outer: outer! as bool,
      ),
...
class OrderByExpr implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.OrderByExpr.html
  const OrderByExpr({required this.expr, this.asc, this.nullsFirst});
  ...
  factory OrderByExpr.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final expr, final asc, final nullsFirst) => OrderByExpr(
        expr: Expr.fromJson(expr),
        asc: Option.fromJson(asc, (some) => some! as bool).value,
        nullsFirst: Option.fromJson(nullsFirst, (some) => some! as bool).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  ...
  factory SqlQuery.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        offset: Option.fromJson(offset, (some) => Offset.fromJson(some)).value,
...
class SqlDeclare implements SqlAst, ToJsonSerializable {
  ...
  List<Object?> toWasm() => [
    ...
    (hold == null ? const None().toWasm() : Option.fromValue(hold).toWasm()),
    query.toWasm(),
  ];
  @override
  String toString() =>
...
sealed class MacroDefinition implements ToJsonSerializable {
  ...
  factory MacroDefinition.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => MacroDefinitionExpr(Expr.fromJson(value)),
      (1, final value) ||
      [1, final value] => MacroDefinitionTable(SqlQuery.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class MacroDefinitionExpr implements MacroDefinition {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'MacroDefinitionExpr',
    'expr': value.toJson(),
  };
...
class MacroDefinitionTable implements MacroDefinition {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'MacroDefinitionTable',
    'table': value.toJson(),
  };
  ...
  factory SqlCreateTable.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        constraints: (constraints! as Iterable)
            .map(TableConstraint.fromJson)
            .toList(),
        tableProperties: (tableProperties! as Iterable)
            .map(SqlOption.fromJson)
            .toList(),
        withOptions: (withOptions! as Iterable)
            .map(SqlOption.fromJson)
            .toList(),
        fileFormat: Option.fromJson(
          fileFormat,
          (some) => FileFormat.fromJson(some),
        ).value,
        location: Option.fromJson(
          location,
          (some) => some is String ? some : (some! as ParsedString).value,
        ).value,
        query: Option.fromJson(query, (some) => SqlQuery.fromJson(some)).value,
        withoutRowid: withoutRowid! as bool,
        like: Option.fromJson(
          like,
          (some) => (some! as Iterable).map(Ident.fromJson).toList(),
        ).value,
        clone: Option.fromJson(
          clone,
          (some) => (some! as Iterable).map(Ident.fromJson).toList(),
        ).value,
        ...
        onCommit: Option.fromJson(
          onCommit,
          (some) => OnCommit.fromJson(some),
        ).value,
...
class WindowFrameBoundCurrentRow implements WindowFrameBound {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'WindowFrameBoundCurrentRow',
    'current-row': null,
  };
...
class WindowSpec implements ToJsonSerializable {
  ...
  factory WindowSpec.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final partitionBy, final orderBy, final windowFrame) => WindowSpec(
        partitionBy: (partitionBy! as Iterable).map(Expr.fromJson).toList(),
        orderBy: (orderBy! as Iterable).map(OrderByExpr.fromJson).toList(),
        windowFrame: Option.fromJson(
          windowFrame,
          (some) => WindowFrame.fromJson(some),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  WindowSpec copyWith({
    ...
    orderBy: orderBy ?? this.orderBy,
    windowFrame: windowFrame != null ? windowFrame.value : this.windowFrame,
  );
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class NamedWindowDefinition implements ToJsonSerializable {
  ...
  const NamedWindowDefinition({required this.name, required this.windowSpec});
  ...
  factory NamedWindowDefinition.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final windowSpec) => NamedWindowDefinition(
        name: Ident.fromJson(name),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  NamedWindowDefinition copyWith({Ident? name, WindowSpec? windowSpec}) =>
      NamedWindowDefinition(
        name: name ?? this.name,
        windowSpec: windowSpec ?? this.windowSpec,
      );
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
sealed class FunctionArgExpr implements ToJsonSerializable {
  ...
  factory FunctionArgExpr.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => FunctionArgExprExpr(Expr.fromJson(value)),
...
class FunctionArgExprExpr implements FunctionArgExpr {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'FunctionArgExprExpr',
    'expr': value.toJson(),
  };
...
class FunctionArgExprWildcard implements FunctionArgExpr {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'FunctionArgExprWildcard',
    'wildcard': null,
  };
...
class FunctionArgExprNamed implements ToJsonSerializable {
  ...
  const FunctionArgExprNamed({required this.name, required this.arg});
  ...
  factory FunctionArgExprNamed.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final name, final arg) => FunctionArgExprNamed(
        name: Ident.fromJson(name),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  FunctionArgExprNamed copyWith({Ident? name, FunctionArgExpr? arg}) =>
...
sealed class FunctionArg implements ToJsonSerializable {
  ...
  factory FunctionArg.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) || [0, final value] => FunctionArgNamed(
        FunctionArgExprNamed.fromJson(value),
      ),
      (1, final value) ||
      [1, final value] => FunctionArgUnnamed(FunctionArgExpr.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class FunctionArgUnnamed implements FunctionArg {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'FunctionArgUnnamed',
    'unnamed': value.toJson(),
  };
  ...
  factory TableFactorTable.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        args: Option.fromJson(
          args,
          (some) => (some! as Iterable).map(FunctionArg.fromJson).toList(),
        ).value,
...
sealed class TableFactor implements ToJsonSerializable {
  ...
  factory TableFactor.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (1, final value) ||
      [1, final value] => TableFactorDerived.fromJson(value),
      (2, final value) ||
      [2, final value] => TableFactorTableFunction.fromJson(value),
      (3, final value) || [3, final value] => TableFactorUnnest.fromJson(value),
      (4, final value) ||
      [4, final value] => TableFactorNestedJoin.fromJson(value),
...
class Join implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.Join.html
  const Join({required this.relation, required this.joinOperator});
  ...
  factory Join.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final relation, final joinOperator) => Join(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Join copyWith({TableFactor? relation, JoinOperator? joinOperator}) => Join(
...
class TableWithJoins implements ToJsonSerializable {
  ...
  /// https://docs.rs/sqlparser/0.35.0/sqlparser/ast/struct.TableWithJoins.html
  const TableWithJoins({required this.relation, required this.joins});
  ...
  factory TableWithJoins.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final relation, final joins) => TableWithJoins(
        relation: TableFactor.fromJson(relation),
  ...
  /// Returns a new instance by overriding the values passed as arguments
  TableWithJoins copyWith({TableFactor? relation, List<Join>? joins}) =>
      TableWithJoins(
        relation: relation ?? this.relation,
...
sealed class Distinct implements ToJsonSerializable {
  ...
  factory Distinct.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (1, final value) || [1, final value] => DistinctOn(
        (value! as Iterable).map(Expr.fromJson).toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class Top implements ToJsonSerializable {
  ...
  factory Top.fromJson(Object? json_) {
    ...
    return switch (json) {
      [final withTies, final percent, final quantity] ||
      (final withTies, final percent, final quantity) => Top(
        withTies: withTies! as bool,
        percent: percent! as bool,
        quantity: Option.fromJson(
          quantity,
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Top copyWith({bool? withTies, bool? percent, Option<Expr>? quantity}) => Top(
    withTies: withTies ?? this.withTies,
    percent: percent ?? this.percent,
    quantity: quantity != null ? quantity.value : this.quantity,
  );
...
class ExprWithAlias implements ToJsonSerializable {
  final Expr expr;
  final Ident alias;
  const ExprWithAlias({required this.expr, required this.alias});
  ...
  /// Returns a new instance by overriding the values passed as arguments
  ExprWithAlias copyWith({Expr? expr, Ident? alias}) =>
...
sealed class SelectItem implements ToJsonSerializable {
  ...
  factory SelectItem.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => SelectItemUnnamedExpr(Expr.fromJson(value)),
      (1, final value) || [1, final value] => SelectItemExprWithAlias(
        ExprWithAlias.fromJson(value),
      ),
      (2, final value) || [2, final value] => SelectItemQualifiedWildcard(
        QualifiedWildcard.fromJson(value),
      ),
      (3, final value) ||
      [3, final value] => SelectItemWildcard(Asterisk.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class SelectItemUnnamedExpr implements SelectItem {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SelectItemUnnamedExpr',
    'unnamed-expr': value.toJson(),
  };
...
class SelectItemWildcard implements SelectItem {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'SelectItemWildcard',
    'wildcard': value.toJson(),
  };
  ...
  factory SqlDelete.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        using: Option.fromJson(
          using,
          (some) => (some! as Iterable).map(TableWithJoins.fromJson).toList(),
        ).value,
        selection: Option.fromJson(
          selection,
          (some) => Expr.fromJson(some),
        ).value,
        returning: Option.fromJson(
          returning,
          (some) => (some! as Iterable).map(SelectItem.fromJson).toList(),
        ).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  ...
  factory SqlSelect.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        distinct: Option.fromJson(
          distinct,
          (some) => Distinct.fromJson(some),
        ).value,
        top: Option.fromJson(top, (some) => Top.fromJson(some)).value,
        projection: (projection! as Iterable).map(SelectItem.fromJson).toList(),
        into: Option.fromJson(into, (some) => SelectInto.fromJson(some)).value,
        from: (from! as Iterable).map(TableWithJoins.fromJson).toList(),
        lateralViews: (lateralViews! as Iterable)
            .map(LateralView.fromJson)
            .toList(),
        selection: Option.fromJson(
          selection,
          (some) => Expr.fromJson(some),
        ...
        namedWindow: (namedWindow! as Iterable)
            ...
            .toList(),
        qualify: Option.fromJson(qualify, (some) => Expr.fromJson(some)).value,
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class Assignment implements ToJsonSerializable {
  final List<Ident> id;
  final Expr value;
  const Assignment({required this.id, required this.value});
  ...
  /// Returns this as a WASM canonical abi value.
  List<Object?> toWasm() => [
    id.map((e) => e.toWasm()).toList(growable: false),
    Expr.toWasm(value),
  ];
  @override
  String toString() =>
  ...
  /// Returns a new instance by overriding the values passed as arguments
  Assignment copyWith({List<Ident>? id, Expr? value}) =>
...
class MatchedUpdate implements MergeClause, ToJsonSerializable {
  ...
  const MatchedUpdate({this.predicate, required this.assignments});
  ...
  factory MatchedUpdate.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final predicate, final assignments) => MatchedUpdate(
        predicate: Option.fromJson(
          predicate,
          (some) => Expr.fromJson(some),
        ).value,
        assignments: (assignments! as Iterable)
    ...
    return switch (json) {
      ...
      (
        ...
        assignments: (assignments! as Iterable)
            .map(Assignment.fromJson)
            .toList(),
        from: Option.fromJson(
          from,
          (some) => TableWithJoins.fromJson(some),
        ).value,
        selection: Option.fromJson(
          selection,
          (some) => Expr.fromJson(some),
...
class DoUpdate implements ToJsonSerializable {
  final List<Assignment> assignments;
  final Expr? selection;
  const DoUpdate({required this.assignments, this.selection});
  ...
  factory DoUpdate.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final assignments, final selection) => DoUpdate(
        assignments: (assignments! as Iterable)
            .map(Assignment.fromJson)
            .toList(),
        selection: Option.fromJson(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  DoUpdate copyWith({List<Assignment>? assignments, Option<Expr>? selection}) =>
      DoUpdate(
        assignments: assignments ?? this.assignments,
        selection: selection != null ? selection.value : this.selection,
      );
...
sealed class OnConflictAction implements ToJsonSerializable {
  ...
  factory OnConflictAction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (1, final value) ||
      [1, final value] => OnConflictActionDoUpdate(DoUpdate.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  ...
  (int, Object?) toWasm();
  static const _spec = Variant([
    Case('do-nothing', null),
    Case('do-update', DoUpdate._spec),
  ]);
}
...
class OnConflictActionDoNothing implements OnConflictAction {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'OnConflictActionDoNothing',
    'do-nothing': null,
  };
...
class OnConflictActionDoUpdate implements OnConflictAction {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'OnConflictActionDoUpdate',
    'do-update': value.toJson(),
  };
...
class OnConflict implements ToJsonSerializable {
  ...
  const OnConflict({this.conflictTarget, required this.action});
  ...
  factory OnConflict.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final conflictTarget, final action) => OnConflict(
        conflictTarget: Option.fromJson(
          conflictTarget,
          (some) => ConflictTarget.fromJson(some),
        ).value,
...
sealed class OnInsert implements ToJsonSerializable {
  ...
  factory OnInsert.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (1, final value) ||
      [1, final value] => OnInsertOnConflict(OnConflict.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class OnInsertOnConflict implements OnInsert {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'OnInsertOnConflict',
    'on-conflict': value.toJson(),
  };
...
class SqlInsert implements SqlAst, ToJsonSerializable {
  ...
  factory SqlInsert.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        or: Option.fromJson(
          or,
          (some) => SqliteOnConflict.fromJson(some),
        ).value,
        into: into! as bool,
        tableName: (tableName! as Iterable).map(Ident.fromJson).toList(),
        columns: (columns! as Iterable).map(Ident.fromJson).toList(),
        ...
        partitioned: Option.fromJson(
          partitioned,
          (some) => (some! as Iterable).map(Expr.fromJson).toList(),
        ).value,
        afterColumns: (afterColumns! as Iterable).map(Ident.fromJson).toList(),
        table: table! as bool,
  ...
  SqlInsert copyWith({
    ...
    source: source ?? this.source,
    partitioned: partitioned != null ? partitioned.value : this.partitioned,
  ...
  factory ArrayAgg.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        orderBy: Option.fromJson(
          orderBy,
          (some) => (some! as Iterable).map(OrderByExpr.fromJson).toList(),
        ).value,
        limit: Option.fromJson(limit, (some) => Expr.fromJson(some)).value,
...
class OnOverflowTruncate implements ToJsonSerializable {
  ...
  const OnOverflowTruncate({this.filler, required this.withCount});
  ...
  factory OnOverflowTruncate.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (final filler, final withCount) => OnOverflowTruncate(
  ...
  /// Returns a new instance by overriding the values passed as arguments
  OnOverflowTruncate copyWith({Option<Expr>? filler, bool? withCount}) =>
      OnOverflowTruncate(
...
sealed class ListAggOnOverflow implements ToJsonSerializable {
  ...
  factory ListAggOnOverflow.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (1, final value) || [1, final value] => ListAggOnOverflowTruncate(
        OnOverflowTruncate.fromJson(value),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
  ...
  static const _spec = Variant([
    Case('error', null),
    Case('truncate', OnOverflowTruncate._spec),
  ]);
}
...
class ListAggOnOverflowError implements ListAggOnOverflow {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ListAggOnOverflowError',
    'error': null,
  };
...
class ListAggOnOverflowTruncate implements ListAggOnOverflow {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'ListAggOnOverflowTruncate',
    'truncate': value.toJson(),
  };
  ...
  factory ListAgg.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        distinct: distinct! as bool,
        expr: Expr.fromJson(expr),
        separator: Option.fromJson(
          separator,
          (some) => Expr.fromJson(some),
        ).value,
        onOverflow: Option.fromJson(
          onOverflow,
          (some) => ListAggOnOverflow.fromJson(some),
        ).value,
        withinGroup: (withinGroup! as Iterable)
            .map(OrderByExpr.fromJson)
            .toList(),
      ),
      _ => throw Exception('Invalid JSON $json_'),
    };
...
sealed class WindowType implements ToJsonSerializable {
  ...
  factory WindowType.fromJson(Object? json_) {
    ...
    return switch (json) {
      (0, final value) ||
      [0, final value] => WindowTypeWindowSpec(WindowSpec.fromJson(value)),
      (1, final value) ||
      [1, final value] => WindowTypeNamedWindow(Ident.fromJson(value)),
      _ => throw Exception('Invalid JSON $json_'),
    };
  }
...
class WindowTypeWindowSpec implements WindowType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'WindowTypeWindowSpec',
    'window-spec': value.toJson(),
  };
...
class WindowTypeNamedWindow implements WindowType {
  ...
  @override
  Map<String, Object?> toJson() => {
    'runtimeType': 'WindowTypeNamedWindow',
    'named-window': value.toJson(),
  };
  ...
  factory SqlFunction.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        over: Option.fromJson(over, (some) => WindowType.fromJson(some)).value,
        distinct: distinct! as bool,
...
class ParsedSql implements ToJsonSerializable {
  ...
  factory ParsedSql.fromJson(Object? json_) {
    ...
    return switch (json) {
      ...
      (
        ...
        sqlQueryRefs: (sqlQueryRefs! as Iterable)
            .map(SqlQuery.fromJson)
            .toList(),
        sqlInsertRefs: (sqlInsertRefs! as Iterable)
            .map(SqlInsert.fromJson)
            .toList(),
        sqlUpdateRefs: (sqlUpdateRefs! as Iterable)
            .map(SqlUpdate.fromJson)
            .toList(),
        sqlSelectRefs: (sqlSelectRefs! as Iterable)
            .map(SqlSelect.fromJson)
            .toList(),
        setExprRefs: (setExprRefs! as Iterable).map(SetExpr.fromJson).toList(),
        exprRefs: (exprRefs! as Iterable).map(Expr.fromJson).toList(),
        dataTypeRefs: (dataTypeRefs! as Iterable)
            .map(DataType.fromJson)
            .toList(),
        arrayAggRefs: (arrayAggRefs! as Iterable)
            .map(ArrayAgg.fromJson)
            .toList(),
        listAggRefs: (listAggRefs! as Iterable).map(ListAgg.fromJson).toList(),
        sqlFunctionRefs: (sqlFunctionRefs! as Iterable)
            .map(SqlFunction.fromJson)
            .toList(),
  ...
  Map<String, Object?> toJson() => {
    ...
    'table-with-joins-refs': tableWithJoinsRefs.map((e) => e.toJson()).toList(),
...
class TypesqlParserWorldImports {
  const TypesqlParserWorldImports();
}

class TypesqlParserWorld {
  final TypesqlParserWorldImports imports;
  final WasmLibrary library;

  TypesqlParserWorld({required this.imports, required this.library})
  ...
  static Future<TypesqlParserWorld> init(
    WasmInstanceBuilder builder, {
    required TypesqlParserWorldImports imports,
  }) async {
    ...
    library = WasmLibrary(
      instance,
      componentId: 'typesql-parser-namespace:typesql-parser/typesql-parser',
      int64Type: Int64TypeConfig.bigInt,
    );
    return TypesqlParserWorld(imports: imports, library: library);
  }

  static final _zoneKey = Object();
  late final _zoneValues = {_zoneKey: this};
  static TypesqlParserWorld? currentZoneWorld() =>
      Zone.current[_zoneKey] as TypesqlParserWorld?;
  T withContext<T>(T Function() fn) => runZoned(fn, zoneValues: _zoneValues);

  final ListValue Function(ListValue) _parseSql;
  Result<ParsedSql, String> parseSql({required String sql}) {
    final results = _parseSql([sql]);
    final result = results[0];
    return withContext(
      () => Result.fromJson(
        result,
        (ok) => ParsedSql.fromJson(ok),
