// Use a procedural macro to generate bindings for the world we specified in `typesql-parser.wit`
wit_bindgen::generate!("typesql-parser");

use sqlparser::ast::{self};

// Comment out the following lines to include other generated wit interfaces
// use exports::typesql_parser_namespace::typesql_parser::*;
// use typesql_parser_namespace::typesql_parser::interface_name;
